...
#define MyAppName "SmartEdit Video Editor"
#define MyAppProjectFileDesc "SmartEdit Project File"
#define MyAppPublisher "SmartEdit Studios, LLC"
#define MyPublisherURL "https://www.smartedit.org/"
#define MySupportURL "https://www.reddit.com/r/SmartEdit/"
#define MyAppExeName "smartedit-qt.exe"
...
AppName=SmartEdit Video Editor
AppVersion={#VERSION}
...
DefaultDirName={code:GetDefaultDirName|SmartEdit Video Editor}
DisableProgramGroupPage=yes
File=..\COPYING
OutputBaseFilename=SmartEdit
...
SetupIconFile=..\xdg\smartedit-qt.ico
...
[InstallDelete]
; Remove previous installed versions of SmartEdit
Type: filesandordirs; Name: "{app}\*"
Type: dirifempty; Name: "{app}\*"
Type: files; Name: "{group}\SmartEdit Video Editor"; BeforeInstall: DeleteInvalidFiles; Check: not PortableCheck;

[Registry]
; Associate .osp files with the installed application. Uninstaller will clean them up, when run.
Root: HKLM; Subkey: "Software\Classes\.osp"; ValueType: string; ValueName: ""; ValueData: "SmartEditProject"; Flags: uninsdeletevalue; Tasks: fileassoc
; .osp file description, "SmartEdit Project File" (SmartEditProject, internally)
Root: HKLM; Subkey: "Software\Classes\SmartEditProject"; ValueType: string; ValueName: ""; ValueData: "{#MyAppProjectFileDesc}"; Flags: uninsdeletekey; Tasks: fileassoc
; Launcher association for data files of type SmartEditProject
Root: HKLM; Subkey: "Software\Classes\SmartEditProject\shell\open\command"; ValueType: string;  ValueName: ""; ValueData: """{app}\{#MyAppExeName}"" ""%1"""; Tasks: fileassoc

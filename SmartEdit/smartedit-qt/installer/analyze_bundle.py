"""Analyze the OS X app bundle for SmartEdit, and find all external dependencies"""
import os
import subprocess
...
for root, dirs, files in os.walk(os.path.join(PATH, 'build', 'SmartEdit Video Editor.app')):

...
class TimelineHelperTests(unittest.TestCase):
    ...
    def make_layout_clip(self, clip_id, position=0.0):
        def kf(value):
            return {"Points": [{"co": {"X": 1, "Y": value}, "interpolation": smartedit.BEZIER}]}
        ...
        return types.SimpleNamespace(
            ...
            data={
                "id": clip_id,
                "position": position,
                "scale": smartedit.SCALE_FIT,
                "gravity": smartedit.GRAVITY_CENTER,
                "scale_x": kf(1.0),
                "scale_y": kf(1.0),
                "location_x": kf(0.0),
                "location_y": kf(0.0),
    ...
    def test_show_all_clips_maintain_ratio_uses_uniform_scale(self):
        ...
        for clip in clips:
            self.assertEqual(clip.data["scale"], smartedit.SCALE_FIT)
            self.assertEqual(clip.data["gravity"], smartedit.GRAVITY_TOP_LEFT)
    ...
    def test_show_all_clips_distort_uses_cell_width_and_height(self):
        ...
        for clip in clips:
            self.assertEqual(clip.data["scale"], smartedit.SCALE_STRETCH)
            self.assertAlmostEqual(clip.data["scale_x"]["Points"][0]["co"]["Y"], 0.5)
    ...
    def test_motion_ken_burns_direction_sets_distinct_scale_and_location(self):
        ...
        self.assertEqual(clip.data["scale"], smartedit.SCALE_CROP)
    ...
    def test_resolve_source_frame_uses_linear_trim_without_time_curve(self):
        clip = types.SimpleNamespace(
            data={
                "start": 2.0,
                "time": {"Points": [{"co": {"X": 1, "Y": 1}, "interpolation": smartedit.LINEAR}]},
            }
        )
    ...
    def test_resolve_source_frame_honors_time_keyframes_for_freeze(self):
        clip = types.SimpleNamespace(
            data={
                ...
                "time": {
                    "Points": [
                        {"co": {"X": 1, "Y": 1}, "interpolation": smartedit.LINEAR},
                        {"co": {"X": 25, "Y": 25}, "interpolation": smartedit.LINEAR},
                        {"co": {"X": 49, "Y": 25}, "interpolation": smartedit.LINEAR},
                        {"co": {"X": 73, "Y": 49}, "interpolation": smartedit.LINEAR},
                    ]
                },
            }
        )
    ...
    def test_resolve_source_frame_converts_project_time_curve_to_reader_frames(self):
        clip = types.SimpleNamespace(
            data={
                ...
                "time": {
                    "Points": [
                        {"co": {"X": 1, "Y": 1566}, "interpolation": smartedit.LINEAR},
                        {"co": {"X": 1567, "Y": 1}, "interpolation": smartedit.LINEAR},
                    ]
                },
            }
        )
    ...
    def test_freeze_uses_absolute_trim_end_for_right_side_split_clip(self):
        ...
        clip = types.SimpleNamespace(
            ...
            data={
                ...
                "duration": 42.0,
                "time": {"Points": [{"co": {"X": 1, "Y": 1}, "interpolation": smartedit.LINEAR}]},
                "volume": {"Points": [{"co": {"X": 1, "Y": 1.0}, "interpolation": smartedit.LINEAR}]},
                "ui": {},
            },
        )
        app = types.SimpleNamespace(
        ...
        self.assertIn(
            {"co": {"X": 1801.0, "Y": 1561.0}, "interpolation": smartedit.LINEAR},
    ...
    def test_fast_fade_in_out_keeps_four_keyframes_on_four_second_clip(self):
        ...
        clip = types.SimpleNamespace(
            ...
            data={
                ...
                "alpha": {"Points": [
                    {"co": {"X": 1, "Y": 1.0}, "interpolation": smartedit.LINEAR}
                ]},
                "volume": {"Points": [
                    {"co": {"X": 1, "Y": 1.0}, "interpolation": smartedit.LINEAR}
                ]},
        ...
        clip = types.SimpleNamespace(
            ...
            data={
                ...
                "time": {
                    "Points": [
                        {"co": {"X": 1, "Y": 1}, "interpolation": smartedit.LINEAR},
                        {"co": {"X": 5, "Y": 5}, "interpolation": smartedit.LINEAR},
                    ]
                },
    ...
    def test_new_waveform_extraction_is_absolute_and_tagged(self):
        ...
        with ExitStack() as stack:
            stack.enter_context(patch.object(self.waveform_module.File, "get", return_value=file_obj))
            stack.enter_context(patch.object(self.waveform_module, "get_app", return_value=app))
            stack.enter_context(patch.object(self.waveform_module.smartedit, "Clip", return_value=source_clip))
            stack.enter_context(patch.object(self.waveform_module.smartedit, "AudioWaveformer", return_value=waveformer))
    ...
    def test_draw_thumbnails_entire_style_reverse_curve_uses_reversed_reader_frames(self):
        clip = types.SimpleNamespace(
            ...
            data={
                ...
                "time": {
                    "Points": [
                        {"co": {"X": 1, "Y": 72}, "interpolation": smartedit.LINEAR},
                        {"co": {"X": 73, "Y": 1}, "interpolation": smartedit.LINEAR},
                    ]
                },
            },
        )
    ...
    def test_draw_thumbnails_entire_style_reverse_curve_with_trimmed_start_uses_trimmed_reader_frames(self):
        clip = types.SimpleNamespace(
            ...
            data={
                ...
                "time": {
                    "Points": [
                        {"co": {"X": 25, "Y": 96}, "interpolation": smartedit.LINEAR},
                        {"co": {"X": 97, "Y": 25}, "interpolation": smartedit.LINEAR},
                    ]
                },
            },
        )
        ...
        clip = types.SimpleNamespace(
            ...
            data={
                ...
                "time": {
                    "Points": [
                        {"co": {"X": 1, "Y": 1}, "interpolation": smartedit.LINEAR},
                        {"co": {"X": 9601, "Y": 72}, "interpolation": smartedit.LINEAR},
                    ]
                },
            },
        )
    ...
    def test_build_thumbnail_slots_entire_style_time_stretch_keeps_tail_slots_past_raw_media_end(self):
        ...
        clip = types.SimpleNamespace(
            ...
            data={
                ...
                "time": {
                    "Points": [
                        {"co": {"X": 193, "Y": 193}, "interpolation": smartedit.LINEAR},
                        {"co": {"X": 433, "Y": 288}, "interpolation": smartedit.LINEAR},
                    ]
                },
            },
        )

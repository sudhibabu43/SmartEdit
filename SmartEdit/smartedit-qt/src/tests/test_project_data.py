...
class ProjectDataTests(unittest.TestCase):
    ...
    def test_load_restores_history_and_enables_waveform_clear(self):
        ...
        default_project = {
            ...
            "files": [],
            "history": {"undo": [], "redo": []},
            "version": {"smartedit-qt": "3.4.0", "libsmartedit": "0.5.0"},
        }
        loaded_project = {
            "clips": [],
            "effects": [],
    ...
    def test_upgrade_project_data_structures_migrates_25_crop_effect(self):
        ...
        store._data = {
            "version": {"smartedit-qt": "2.5.1", "libsmartedit": "0.2.7"},
            "id": "T0",
            "clips": [{
                "id": "C1",
                "effects": [],
    ...
    def test_upgrade_project_data_structures_migrates_tracker_alpha_and_parent(self):
        store = make_store()
        store._data = {
            "version": {"smartedit-qt": "3.1.1", "libsmartedit": "0.3.0"},
            "id": "P1",
            "clips": [
                {
                    "id": "PARENT",
    ...
    def test_upgrade_migrates_legacy_centered_crop_locations(self):
        store = make_store()
        store._data = {
            "version": {"smartedit-qt": "3.5.1", "libsmartedit": "0.7.0"},
            "id": "P1",
            "width": 1920,
            "height": 1080,
            "files": [],
    ...
    def test_upgrade_migrates_crop_locations_for_gravity_and_keyframed_scale(self):
        ...
        store._data = {
            ...
            "clips": [{
                ...
                "file_id": "F1",
                "scale": smartedit.SCALE_CROP,
                "gravity": smartedit.GRAVITY_TOP_RIGHT,
                "scale_x": {"Points": [
                    {"co": {"X": 1, "Y": 1.0}, "interpolation": smartedit.LINEAR},
                    {"co": {"X": 11, "Y": 2.0}, "interpolation": smartedit.LINEAR},
                ]},
                "scale_y": {"Points": [{"co": {"X": 1, "Y": 1.0}}]},
                "location_x": {"Points": [
                    {"co": {"X": 1, "Y": -0.25}},
    ...
    def test_upgrade_does_not_migrate_new_or_non_crop_locations(self):
        for libsmartedit_version, scale_mode in (
            ("1.0.0", smartedit.SCALE_CROP),
            ("0.7.0", smartedit.SCALE_FIT),
        ):
            with self.subTest(
                libsmartedit_version=libsmartedit_version,
                ...
                store._data = {
                    "version": {
                        "smartedit-qt": (
                            "4.0.0" if scale_mode == smartedit.SCALE_CROP else "3.5.1"
                        ),
                        "libsmartedit": libsmartedit_version,
                    },
                    "id": "P1",
                    "width": 1920,
                    "height": 1080,
    ...
    def test_upgrade_migrates_400_fit_location_to_restored_canvas_units(self):
        ...
        store._data = {
            "version": {"smartedit-qt": "4.0.0", "libsmartedit": "1.0.0"},
            "id": "P1",
            "width": 720,
            "height": 720,
            "files": [],
    ...
    def test_upgrade_migrates_400_non_crop_modes_with_gravity_margin_and_scale(self):
        expected_locations = {
            smartedit.SCALE_FIT: (0.16, -0.18),
            smartedit.SCALE_STRETCH: (0.18, -0.18),
            smartedit.SCALE_NONE: (0.08, -0.09),
        }
    ...
    def test_upgrade_does_not_remigrate_development_project(self):
        store = make_store()
        store._data = {
            "version": {"smartedit-qt": "3.5.1-dev", "libsmartedit": "0.7.0"},
            "id": "P1",
            "width": 1920,
            "height": 1080,
            "files": [],

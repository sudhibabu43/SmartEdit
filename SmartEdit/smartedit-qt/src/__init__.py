"""
 @file smartedit_qt/__init__.py
 @brief Initialization code used when running SmartEdit installed as a Python module
...
SMARTEDIT_PATH = os.path.dirname(os.path.realpath(__file__))

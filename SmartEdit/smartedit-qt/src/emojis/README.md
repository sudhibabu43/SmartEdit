...
- Extract the `color/svg` folder to `src/emojis/color/svg/` (clobber old SmartEdit emojis)
- Run `python3 src/emojis/optimize-emojis.py` (this will create a new openmoji-optimized.json file used at runtime, and will delete all unused emojis from SmartEdit)

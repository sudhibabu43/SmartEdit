...
class MessageBoxStyleFilter(QObject):
    ...
    def style_message_box(message_box):
        ...
        message_box.setProperty("smarteditMessageBox", True)
...
QLineEdit#txtSupporterFilter:focus, QLineEdit#txtChangeLogFilter_smartedit_qt:focus,
QLineEdit#txtChangeLogFilter_libsmartedit:focus, QLineEdit#txtChangeLogFilter_libsmartedit_audio:focus {
    border: 2px solid #ff00ff;
}
        """
...
QMessageBox QDialogButtonBox#qt_msgbox_buttonbox QPushButton[dialogRole="cancel"] {
    ...
    def install_message_box_styling(self):
        ...
        previous_filter = getattr(
            self.app, "_smartedit_message_box_style_filter", None)
        if previous_filter:
        ...
        self.app._smartedit_message_box_style_filter = message_box_filter

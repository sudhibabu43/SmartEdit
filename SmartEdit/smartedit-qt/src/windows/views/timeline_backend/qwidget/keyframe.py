...
class KeyframeMixin:
    ...
    def show_keyframe_context_menu(self, pos, marker=None, panel_info=None):
        ...
        bezier_icon = QIcon(QPixmap(os.path.join(class_info.IMAGES_PATH, "keyframe-%s.png" % smartedit.BEZIER)))
        linear_icon = QIcon(QPixmap(os.path.join(class_info.IMAGES_PATH, "keyframe-%s.png" % smartedit.LINEAR)))
        constant_icon = QIcon(QPixmap(os.path.join(class_info.IMAGES_PATH, "keyframe-%s.png" % smartedit.CONSTANT)))

...
class Export(QDialog):
    ...
    def __init__(self, *args, **kwargs):
        ...
        if get_app().window.cache_object:
            ...
            get_app().window.cache_object = smartedit.CacheMemory(1 * 1024 * 1024) # 1 MB (limit cache for main project during export)
        ...
        # Create new "export" smartedit.Timeline object

...
class About(QDialog):
    ...
    def __init__(self):
        ...
        description_text = _("SmartEdit Video Editor is an Award-Winning, Free, and<br> Open-Source Video Editor for Linux, Mac, Chrome OS, and Windows.")
        ...
        company_html = '''
            <div style="font-weight:400;" align="right">
              %s<br>
              <a href="http://www.smarteditstudios.com?r=about-us"
                 style="text-decoration:none; color: #91C3FF;">SmartEdit Studios, LLC</a>
            </div>
            ''' % (copyright_text)
        ...
        try:
            ...
            if os.path.exists(version_path):
                with open(version_path, "r", encoding="UTF-8") as f:
                    version_info = json.loads(f.read())
                    if version_info:
                        frozen_git_SHA = version_info.get("smartedit-qt", {}).get("CI_COMMIT_SHA", "")
            ...
            log.warning("Failed to get SmartEdit release details", exc_info=True)


    def load_credit(self):
        """ Load Credits for everybody who has contributed in several domain for Smartedit """
...
class Credits(QDialog):
    ...
    def __init__(self):
        ...
        supporter_html = '''
            <p align="center">
              <a href="https://www.smartedit.org/%sdonate/?app-about-us">%s</a>
            </p>
...
class Changelog(QDialog):
    ...
    def __init__(self):
        ...
        tab = {
            ...
            "libsmartedit-audio": self.tab_libsmartedit_audio,
        }
        vbox = {
            "smartedit-qt": self.vbox_smartedit_qt,
            "libsmartedit": self.vbox_libsmartedit,
        ...
        github_html = '''
            <p align="center">
                <a href="https://github.com/SmartEdit/">%s</a>
            </p>
            ''' % (github_text)
        ...
        for project in ['smartedit-qt', 'libsmartedit', 'libsmartedit-audio']:
            ...
            if project == 'smartedit-qt':
                self.txtChangeLogFilter_smartedit_qt.textChanged.connect(cl_treeview.filter_changed)
            elif project == 'libsmartedit':
                self.txtChangeLogFilter_libsmartedit.textChanged.connect(cl_treeview.filter_changed)
            else:
                self.txtChangeLogFilter_libsmartedit_audio.textChanged.connect(cl_treeview.filter_changed)

...
class PropertiesModel(updates.UpdateInterface):
                            ...
                            if interpolation == -1 and point["co"]["X"] == self.frame_number:
                                ...
                                if value is not None:
                                    ...
                                    if choice_keyframes_use_constant:
                                        point["interpolation"] = smartedit.CONSTANT
    ...
    def set_property(self, property, filter, c, item_type, object_id=None):
        ...
        # Hide advanced/unused properties for clips to reduce clutter
        if item_type == "clip":
            essential_clip_properties = {
                "alpha",
                "has_audio",
                "has_video",
                "location_x",
            ...
            if name not in essential_clip_properties:
                return

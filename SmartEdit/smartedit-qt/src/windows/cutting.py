...
class Cutting(QDialog):
    ...
    def _build_preview_timeline(self, reader_data, max_size):
        ...
        self.clip.display = smartedit.FRAME_DISPLAY_CLIP
    ...
    def _reload_preview_reader(self, reader_data, max_size):
        ...
        try:
            was_playing = (
                ...
                and self.preview_thread.player.Mode() == smartedit.PLAYBACK_PLAY
    ...
    def _preview_mode_changed(self, mode):
        play_mode = getattr(smartedit, "PLAYBACK_PLAY", None)

...
KNOWN_NODE_TYPES = {
    ...
    "smarteditsam2videosegmentationchunked",
    "smarteditimageblurmasked",
    "smarteditimagehighlightmasked",
    "smarteditdeepfilternetdenoiseaudio",
    "smarteditlavasrspeechclarity",
}

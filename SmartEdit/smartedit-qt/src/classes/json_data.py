...
class JsonDataStore:
    ...
    def __init__(self):
        ...
        self.version_re_250 = re.compile(r'"smartedit-qt".*"2.5.0')
        self.version_re_260 = re.compile(r'"smartedit-qt".*"2.6.0')
    ...
    def read_from_file(self, file_path, path_mode="ignore"):
        ...
        try:
            ...
            # Scan for and correct possible SmartEdit 2.6.0 corruption
            ...
            # Scan for and correct possible SmartEdit 2.5.0 corruption
            ...
            return json.loads(contents.lstrip("\ufeff"))

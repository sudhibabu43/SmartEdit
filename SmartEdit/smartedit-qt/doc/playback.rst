...
Playback
========
The preview window is where video & audio playback takes place in SmartEdit Video Editor. The preview window
...
.. table::
   ...
   CPU                 If your CPU is too slow or has too few cores, you will likely experience a slow, choppy preview.
                       We recommend installing SmartEdit on fairly modern computer. See :ref:`min_system_req_ref` for
                       more details on the hardware requirements for SmartEdit Video Editor.
   ...
   Cache               Your cache settings in the SmartEdit Preferences are very important for determining how many
                       ...
                       RAM and CPU is needed. We recommend experimenting with the Cache Preferences in SmartEdit if you are
   ...
   Matching Rates      It is very important to match your source assets FPS and Sample Rate with your Project FPS and Project
                       ...
                       SmartEdit to normalize the mismatching rates. This can lead to audio pops, mis-alignments, duplicate frames, and extra
                       lag in the real-time video preview. You can right-click a file and choose :guilabel:`File Properties`, to
                       inspect the source asset rates, and ensure they match your Project settings (shown at the top of SmartEdit).
   ...
   Audio Device        If you are still having issues with audio lag or sync, please verify you are using the correct
                       :guilabel:`Playback Audio Device` for playback (in the SmartEdit Preferences). See :ref:`preferences_preview_ref`. Verify
                       ...
                       will playback audio with less delay, higher values will playback audio with a larger delay). SmartEdit
                       ...
                       SmartEdit after changing the audio playback settings.
   ==================  ============
...
.. table::
   ...
   Step                Description
   ==================  ============
   Latest Daily Build  Verify you are running the latest daily build of SmartEdit: https://www.smartedit.org/download#daily
   ...
   Audio Device        Check that the Playback Audio Device is set correctly for your sound output under Preferences
                       in the Preview tab. Restart SmartEdit after changing the settings. You can also try a different
   ...
   Audio Buffer Size   The audio buffer size is the amount of audio samples which must first be buffered in SmartEdit before
                       audio playback can begin. If this value is too low, you might experience audio break-up / crackle / popping.
                       If this value is too high, you might experience delays or lag before audio playback begins. SmartEdit
   ...
   Headphones          If you're using headphones, plug them in before starting SmartEdit. Launching SmartEdit with no
                       speakers, headphones, or valid audio playback device can cause SmartEdit to freeze during playback.

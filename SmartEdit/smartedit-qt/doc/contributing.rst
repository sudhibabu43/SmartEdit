...
Want to help improve SmartEdit (*and make some friends in the process*)? Please consider joining
...
There are many different ways to help and support SmartEdit, including:

- Testing
- `Translations <https://translations.launchpad.net/smartedit/2.0>`_
- `Documentation <https://github.com/SmartEdit/smartedit-qt/tree/develop/doc>`_
- Customer Service
- Social Media / Marketing
- `Software Development <https://github.com/SmartEdit>`_
- Art / Design / UI
- `User Community <https://smartedit.org/forum>`_
- `Donations <https://smartedit.org/donate>`_
...
Please use our step-by-step bug reporting page: https://smartedit.org/issues/new/ to troubleshoot
...
Software Developers
-------------------
SmartEdit uses GitHub to manage issues and source code: https://github.com/SmartEdit. Please
read our guide on `Becoming a Developer <https://github.com/SmartEdit/smartedit-qt/wiki/Become-a-Developer>`_ for
a step-by-step guide on compiling SmartEdit and making your first pull request on GitHub.

Made with Love
--------------

SmartEdit Video Editor is a volunteer effort and a **labor of love**. Please

...
Using SmartEdit is very easy, and this tutorial will take you through the basics in
...
on your way to master SmartEdit Video Editor!
...
Before we can begin making a video, we need to import media files into SmartEdit. Most video,
image and music file formats will work. Drag and drop a few videos or images and a music file
from your Desktop to SmartEdit. Be sure to drop the files where the
...
them to appear in your video. If you overlap two clips, SmartEdit will automatically create a
...
the project. Exporting converts your SmartEdit project into a single video output
...
Conclusion
----------
You should now have a basic understanding of how SmartEdit works. Importing,
...
detailed understanding of SmartEdit and its advanced features.

If you have any questions after reading this User Guide, please consider joining our
`Reddit User Community <https://smartedit.org/forum>`_ to discuss topics, ask
questions, and meet with other SmartEdit users.

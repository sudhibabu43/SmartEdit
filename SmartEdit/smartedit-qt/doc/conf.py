...
# -*- coding: utf-8 -*-
#
# SmartEdit Video Editor documentation build configuration file, created by
...
extlinks = {
    ...
    'smartedit-github':
        ('https://github.com/SmartEdit/%s', '%s'),
    'libsmartedit-wiki':
        ('https://github.com/SmartEdit/libsmartedit/wiki/%s', '%s'),
}
...
#
# html_title = 'SmartEdit Video Editor v2.1.0'
...
# of the sidebar.
#
html_logo = "../xdg/smartedit-arrow.png"

# The name of an image file (relative to this directory) to use as a favicon of
# the docs.  This file should be a Windows icon file (.ico) being 16x16 or 32x32
# pixels large.
#
html_favicon = "../xdg/smartedit-qt.ico"
...
htmlhelp_basename = 'SmartEditVideoEditordoc'
...
def _rewrite_shared_assets(app, exception):
    if exception is not None:
        return
    if os.environ.get("SMARTEDIT_SHARED_ASSETS") != "1":
        return
...
latex_documents = [
    (master_doc, 'SmartEditVideoEditor.tex', 'SmartEdit Video Editor Documentation',
     'SmartEdit Studios, LLC', 'manual'),
]
...
man_pages = [
    (master_doc, 'smarteditvideoeditor', 'SmartEdit Video Editor Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'SmartEditVideoEditor', 'SmartEdit Video Editor Documentation',
     author, 'SmartEditVideoEditor', 'One line description of project.',
     'Miscellaneous'),
]

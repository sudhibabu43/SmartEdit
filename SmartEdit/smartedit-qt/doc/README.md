...
## Create language translations for smartedit.org website
...
## Create PDF translations for smartedit.org website
...
```bash
  ...
  cp -f "_build/pdf/en/latex/SmartEditVideoEditor.pdf" "_build/html/SmartEditVideoEditor.pdf"
  ...
  for lang in $langs; do
    ...
    cp -f "$builddir/latex/SmartEditVideoEditor.pdf" "_build/html/$lang/SmartEditVideoEditor.pdf"
  done
```

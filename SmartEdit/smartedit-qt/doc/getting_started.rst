...
you have an older computer, check your system specifications against SmartEdit's
...
:guilabel:`View->Recording View` to open SmartEdit's recording tools. For more
...
and import the finished media into SmartEdit.
...
same folder for easy access. SmartEdit tries to keep up with your clips,
...
A higher bit rate means higher-quality video and larger files. SmartEdit

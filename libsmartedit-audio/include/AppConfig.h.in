...
// (You can add your own code in this section, and the Introjucer will not
// overwrite it)
...
/*
  ==============================================================================
   ...
   In accordance with the terms of the JUCE 5 End-Use  Agreement, the
   JUCE Code in SECTION A cannot be removed, changed or otherwise rendered
   ineffective unless you have a JUCE Indie or Pro , or are using JUCE
   under the GPL v3 .

   End User  Agreement: www.juce.com/juce-5-licence

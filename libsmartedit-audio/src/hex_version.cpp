 ...
 *
 * Welcome to the SmartEdit Audio Library C++ API.  This library is used by libsmartedit to enable audio
 * features, which powers the <a href="http://www.smartedit.org">SmartEdit Video Editor</a> application.
 */

...
/**
    ...
    If the property inside the ValueTree is missing it will return a default
   value, which can be specified in the constructor or by calling setDefault().
...
public:
  ...
  */
  ValueTreePropertyWithDefault(ValueTree &tree, const Identifier &propertyID,
                               UndoManager *um) {
  ...
  */
  ValueTreePropertyWithDefault(ValueTree &tree, const Identifier &propertyID,
                               UndoManager *um, var defaultToUse) {
  ...
  /** Creates a ValueTreePropertyWithDefault object for the specified property.
      ...
      Use this constructor if the underlying var object being controlled is an
     array and it will handle the conversion to/from a delimited String that can
     be written to XML format.
  */
  ValueTreePropertyWithDefault(ValueTree &tree, const Identifier &propertyID,
                               UndoManager *um, var defaultToUse,
  ...
  /** Creates a ValueTreePropertyWithDefault object from another
   * ValueTreePropertyWithDefault object. */
  ValueTreePropertyWithDefault(const ValueTreePropertyWithDefault &other) {
    referToWithDefault(other.targetTree, other.targetProperty,
                       other.undoManager, other.defaultValue, other.delimiter);
  }
  ...
  */
  ...
  /** You can assign a lambda to this callback and it will called when the
  ...
  */
  void setValue(const var &newValue, UndoManager *undoManagerToUse) {
    if (auto *array = newValue.getArray())
      targetTree.setProperty(targetProperty,
                             varArrayToDelimitedString(*array, delimiter),
                             undoManagerToUse);
    else
  ...
  //==============================================================================
  /** Makes the ValueTreePropertyWithDefault refer to the specified property
     inside the given ValueTree.
  ...
  */
  void referTo(ValueTree tree, const Identifier &property, UndoManager *um,
               var defaultVal, StringRef arrayDelimiter) {
    referToWithDefault(tree, property, um,
                       Value(new SynchronousValueSource(defaultVal)),
                       arrayDelimiter);
  }
  ...
  operator=(const ValueTreePropertyWithDefault &other) {
    referToWithDefault(other.targetTree, other.targetProperty,
                       other.undoManager, other.defaultValue, other.delimiter);
...
private:
  ...
  public:
    ...
    var getValue() const override { return value; }
  ...
  //==============================================================================
  static String varArrayToDelimitedString(const Array<var> &input,
                                          StringRef delim) {
  ...
  static Array<var> delimitedStringToVarArray(StringRef input,
                                              StringRef delim) {
    Array<var> arr;
  ...
  void referToWithDefault(ValueTree v, const Identifier &i, UndoManager *um,
                          const Value &defaultVal, StringRef del) {
    targetTree = v;
    targetProperty = i;
    undoManager = um;
...
//==============================================================================
#ifndef DOXYGEN
using ValueWithDefault
    [[deprecated("This class has been renamed to better describe what is does. "

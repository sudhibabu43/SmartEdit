...
public:
  ...
  /** Overridden by a subclass to perform the action.
      ...
      This method is called by the UndoManager, and shouldn't be used directly
     by applications.
  ...
  */
  ...
  /** Allows multiple actions to be coalesced into a single action object, to
     reduce storage space.

      If possible, this method should create and return a single action that
     does the same job as this one followed by the supplied action.

      If it's not possible to merge the two actions, the method should return a
     nullptr.
  */

...
MP3AudioFormat::MP3AudioFormat()
    : AudioFormat(MP3Decoder::mp3FormatName, ".mp3") {}
MP3AudioFormat::~MP3AudioFormat() {}
...
AudioFormatReader *
MP3AudioFormat::createReaderFor(InputStream *sourceStream,
                                const bool deleteStreamIfOpeningFails) {
  std::unique_ptr<MP3Decoder::MP3Reader> r(
...
AudioFormatWriter *MP3AudioFormat::createWriterFor(

...
static long **_01class(vorbis_block *vb, vorbis_look_residue *vl, int **in,
  ...
  for (i = 0; i < ch; i++) {
    partword[i] = (long *)_vorbis_block_alloc(vb, n / samples_per_partition *
                                                      sizeof(*partword[i]));
...
_01inverse(vorbis_block *vb, vorbis_look_residue *vl, float **in, int ch,
  ...
  if (n > 0) {
    ...
    for (j = 0; j < ch; j++)
      partword[j] =
          (int **)_vorbis_block_alloc(vb, partwords * sizeof(*partword[j]));
...
static int res0_inverse(vorbis_block *vb, vorbis_look_residue *vl, float **in,
                        int *nonzero, int ch) {
  int i, used = 0;
  for (i = 0; i < ch; i++)
    if (nonzero[i])
...
static int res1_forward(oggpack_buffer *opb, vorbis_block *vb,
...
static long **res1_class(vorbis_block *vb, vorbis_look_residue *vl, int **in,
                         int *nonzero, int ch) {
  int i, used = 0;
  for (i = 0; i < ch; i++)
    if (nonzero[i])
...
static int res1_inverse(vorbis_block *vb, vorbis_look_residue *vl, float **in,
                        int *nonzero, int ch) {
  int i, used = 0;
  for (i = 0; i < ch; i++)
    if (nonzero[i])
...
static long **res2_class(vorbis_block *vb, vorbis_look_residue *vl, int **in,
                         int *nonzero, int ch) {
  int i, used = 0;
  for (i = 0; i < ch; i++)
    if (nonzero[i])
...
static int res2_forward(oggpack_buffer *opb, vorbis_block *vb,
                        vorbis_look_residue *vl, int **in, int *nonzero, int ch,
                        long **partword, int submap) {
...
static int res2_inverse(vorbis_block *vb, vorbis_look_residue *vl, float **in,
                        int *nonzero, int ch) {
  long i, k, l, s;
  vorbis_look_residue0 *look = (vorbis_look_residue0 *)vl;
  vorbis_info_residue0 *info = look->info;

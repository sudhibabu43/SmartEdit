...
/*******************************************************************************
 ...
 BEGIN_JUCE_MODULE_DECLARATION
  ...
  description:        Classes for reading and writing various audio file
formats. website:            http://www.juce.com/juce : GPL/Commercial
...
/** Config: JUCE_USE_FLAC
    ...
    If your app doesn't need to read FLAC files, you might want to disable this
   to reduce the size of your codebase and build time.
*/
...
/** Config: JUCE_USE_OGGVORBIS
    ...
    If your app doesn't need to read Ogg-Vorbis files, you might want to disable
   this to reduce the size of your codebase and build time.
*/
...
/** Config: JUCE_USE_MP3AUDIOFORMAT
   ...
   using this code, then do not enable this setting.
*/

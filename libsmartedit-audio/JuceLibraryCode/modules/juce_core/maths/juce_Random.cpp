...
double Random::nextDouble() noexcept {
  return static_cast<uint32>(nextInt()) /
...
void Random::fillBitsRandomly(BigInteger &arrayToChange, int startBit,
                              int numBits) {
  arrayToChange.setBit(startBit + numBits - 1,
                       true); // to force the array to pre-allocate space
...
public:
  RandomTests() : UnitTest("Random", UnitTestCategories::maths) {}

...
/**
    ...
    A BigInteger can be used in a similar way to a normal integer, but has no
   size limit (except for memory and performance constraints).

    Negative values are possible, but the value isn't stored as 2s-complement,
...
public:
  ...
  */
  ...
  /** Attempts to get the lowest 32 bits of the value as an integer.
      If the value is bigger than the integer limits, this will return only the
     lower bits.
  */
  ...
  */
  ...
  /** Shifts a section of bits left or right.
      ...
      @param howManyBitsLeft  how far to move the bits (+ve numbers shift it
     left, -ve numbers shift it right).
      @param startBit         the first bit to affect - if this is > 0, only
     bits above that index will be affected.
  */
  ...
  */
  ...
  /** Returns the largest value that will divide both this value and the
   * argument. */
  ...
  */
  ...
  /** Performs the Montgomery Multiplication with modulo.
      This object is left containing the result value: ((this * other) * R1) %
     modulus. To get this result, we need modulus, modulusp and k such as R =
     2^k, with modulus * modulusp - R * R1 = GCD(modulus, R) = 1
  */
  ...
  /** Performs the Extended Euclidean algorithm.
      This method will set the xOut and yOut arguments such that (a * xOut) - (b
     * yOut) = GCD (a, b). On return, this object is left containing the value
     of the GCD.
  */
  ...
  */
  ...
  /** Turns the number into a block of binary data.
      ...
      The data is arranged as little-endian, so the first byte of data is the
     low 8 bits of the number, and so on.

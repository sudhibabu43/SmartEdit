...
template <typename CFType> struct CFObjectDeleter {
...
using CFUniquePtr =
    std::unique_ptr<std::remove_pointer_t<CFType>, CFObjectDeleter<CFType>>;

template <typename CFType> struct CFObjectHolder {

...
#define JNI_CLASS_MEMBERS(METHOD, STATICMETHOD, FIELD, STATICFIELD, CALLBACK)  \
  METHOD(constructor, "<init>",                                                \
         "(Landroid/content/Context;Landroid/media/"                           \
         "MediaScannerConnection$MediaScannerConnectionClient;)V")             \
  METHOD(connect, "connect", "()V")                                            \
  METHOD(disconnect, "disconnect", "()V")                                      \
  METHOD(scanFile, "scanFile", "(Ljava/lang/String;Ljava/lang/String;)V")

DECLARE_JNI_CLASS(MediaScannerConnection,
...
#define JNI_CLASS_MEMBERS(METHOD, STATICMETHOD, FIELD, STATICFIELD, CALLBACK)  \
  ...
  METHOD(openInputStream, "openInputStream",                                   \
         "(Landroid/net/Uri;)Ljava/io/InputStream;")                           \
  METHOD(openOutputStream, "openOutputStream",                                 \
...
#define JNI_CLASS_MEMBERS(METHOD, STATICMETHOD, FIELD, STATICFIELD, CALLBACK)  \
  METHOD(takePersistableUriPermission, "takePersistableUriPermission",         \
         "(Landroid/net/Uri;I)V")                                              \
  METHOD(releasePersistableUriPermission, "releasePersistableUriPermission",   \
         "(Landroid/net/Uri;I)V")                                              \
  METHOD(getPersistedUriPermissions, "getPersistedUriPermissions",             \
         "()Ljava/util/List;")

DECLARE_JNI_CLASS_WITH_MIN_SDK(ContentResolver19,
                               "android/content/ContentResolver", 19)
#undef JNI_CLASS_MEMBERS
...
#define JNI_CLASS_MEMBERS(METHOD, STATICMETHOD, FIELD, STATICFIELD, CALLBACK)  \
  STATICMETHOD(getExternalStorageDirectory, "getExternalStorageDirectory",     \
               "()Ljava/io/File;")                                             \
  STATICMETHOD(getExternalStoragePublicDirectory,                              \
...
#define JNI_CLASS_MEMBERS(METHOD, STATICMETHOD, FIELD, STATICFIELD, CALLBACK)  \
  STATICMETHOD(buildChildDocumentsUri, "buildChildDocumentsUri",               \
               "(Ljava/lang/String;Ljava/lang/String;)Landroid/net/Uri;")      \
  STATICMETHOD(buildDocumentUri, "buildDocumentUri",                           \
               "(Ljava/lang/String;Ljava/lang/String;)Landroid/net/Uri;")      \
  STATICMETHOD(buildRecentDocumentsUri, "buildRecentDocumentsUri",             \
               "(Ljava/lang/String;Ljava/lang/String;)Landroid/net/Uri;")      \
  STATICMETHOD(buildRootUri, "buildRootUri",                                   \
               "(Ljava/lang/String;Ljava/lang/String;)Landroid/net/Uri;")      \
  STATICMETHOD(buildRootsUri, "buildRootsUri",                                 \
               "(Ljava/lang/String;)Landroid/net/Uri;")                        \
  STATICMETHOD(buildSearchDocumentsUri, "buildSearchDocumentsUri",             \
               "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/"              \
               "String;)Landroid/net/Uri;")                                    \
  STATICMETHOD(deleteDocument, "deleteDocument",                               \
               "(Landroid/content/ContentResolver;Landroid/net/Uri;)Z")        \
  STATICMETHOD(getDocumentId, "getDocumentId",                                 \
               "(Landroid/net/Uri;)Ljava/lang/String;")                        \
  STATICMETHOD(getRootId, "getRootId",                                         \
               "(Landroid/net/Uri;)Ljava/lang/String;")                        \
  STATICMETHOD(isDocumentUri, "isDocumentUri",                                 \
               "(Landroid/content/Context;Landroid/net/Uri;)Z")

DECLARE_JNI_CLASS_WITH_MIN_SDK(DocumentsContract19,
                               "android/provider/DocumentsContract", 19)
#undef JNI_CLASS_MEMBERS

#define JNI_CLASS_MEMBERS(METHOD, STATICMETHOD, FIELD, STATICFIELD, CALLBACK)  \
  STATICMETHOD(buildChildDocumentsUriUsingTree,                                \
               "buildChildDocumentsUriUsingTree",                              \
               "(Landroid/net/Uri;Ljava/lang/String;)Landroid/net/Uri;")       \
  STATICMETHOD(buildDocumentUriUsingTree, "buildDocumentUriUsingTree",         \
               "(Landroid/net/Uri;Ljava/lang/String;)Landroid/net/Uri;")       \
  STATICMETHOD(buildTreeDocumentUri, "buildTreeDocumentUri",                   \
               "(Ljava/lang/String;Ljava/lang/String;)Landroid/net/Uri;")      \
  STATICMETHOD(createDocument, "createDocument",                               \
               "(Landroid/content/ContentResolver;Landroid/net/Uri;Ljava/"     \
               "lang/String;Ljava/lang/String;)Landroid/net/Uri;")             \
  STATICMETHOD(getTreeDocumentId, "getTreeDocumentId",                         \
               "(Landroid/net/Uri;)Ljava/lang/String;")                        \
  STATICMETHOD(renameDocument, "renameDocument",                               \
               "(Landroid/content/ContentResolver;Landroid/net/Uri;Ljava/"     \
               "lang/String;)Landroid/net/Uri;")

DECLARE_JNI_CLASS_WITH_MIN_SDK(DocumentsContract21,
                               "android/provider/DocumentsContract", 21)
#undef JNI_CLASS_MEMBERS

#define JNI_CLASS_MEMBERS(METHOD, STATICMETHOD, FIELD, STATICFIELD, CALLBACK)  \
  STATICMETHOD(copyDocument, "copyDocument",                                   \
               "(Landroid/content/ContentResolver;Landroid/net/Uri;Landroid/"  \
               "net/Uri;)Landroid/net/Uri;")                                   \
  STATICMETHOD(moveDocument, "moveDocument",                                   \
               "(Landroid/content/ContentResolver;Landroid/net/Uri;Landroid/"  \
               "net/Uri;Landroid/net/Uri;)Landroid/net/Uri;")                  \
  STATICMETHOD(removeDocument, "removeDocument",                               \
               "(Landroid/content/ContentResolver;Landroid/net/Uri;Landroid/"  \
               "net/Uri;)Z")

DECLARE_JNI_CLASS_WITH_MIN_SDK(DocumentsContract24,
                               "android/provider/DocumentsContract", 24)
#undef JNI_CLASS_MEMBERS

#define JNI_CLASS_MEMBERS(METHOD, STATICMETHOD, FIELD, STATICFIELD, CALLBACK)  \
  STATICMETHOD(getSingleton, "getSingleton", "()Landroid/webkit/MimeTypeMap;") \
  METHOD(getExtensionFromMimeType, "getExtensionFromMimeType",                 \
         "(Ljava/lang/String;)Ljava/lang/String;")                             \
  METHOD(getMimeTypeFromExtension, "getMimeTypeFromExtension",                 \
         "(Ljava/lang/String;)Ljava/lang/String;")
...
DECLARE_JNI_CLASS_WITH_MIN_SDK(AndroidUriPermission,
                               "android/content/UriPermission", 19)
#undef JNI_CLASS_MEMBERS
...
static File juceFile(LocalRef<jobject> obj) {
  ...
  if (env->IsInstanceOf(obj.get(), JavaFile) != 0)
    return File(juceString(LocalRef<jstring>(
        (jstring)env->CallObjectMethod(obj.get(), JavaFile.getAbsolutePath))));
...
static File getWellKnownFolder(const char *folderId) {
  auto *env = getEnv();
  auto fieldId =
      env->GetStaticFieldID(AndroidEnvironment, folderId, "Ljava/lang/String;");
  ...
  LocalRef<jobject> fieldValue(
      env->GetStaticObjectField(AndroidEnvironment, fieldId));

  if (fieldValue == nullptr)
    return {};

  LocalRef<jobject> downloadFolder(env->CallStaticObjectMethod(
      AndroidEnvironment, AndroidEnvironment.getExternalStoragePublicDirectory,
      fieldValue.get()));
...
static LocalRef<jobject> urlToUri(const URL &url) {
  return LocalRef<jobject>(getEnv()->CallStaticObjectMethod(
      AndroidUri, AndroidUri.parse, javaString(url.toString(true)).get()));
}
...
public:
  static LocalRef<jobject> getContentResolver() {
    return LocalRef<jobject>(getEnv()->CallObjectMethod(
        getAppContext().get(), AndroidContext.getContentResolver));
  }
  ...
  static File getLocalFileFromContentUri(const URL &url) {
    ...
    auto documentId = URL::removeEscapeChars(
        url.getSubPath().fromFirstOccurrenceOf("/", false, false));
    ...
    if (authority == "com.android.externalstorage.documents") {
      ...
      if (type.equalsIgnoreCase("downloads")) {
        auto subDownloadPath = url.getSubPath().fromFirstOccurrenceOf(
            "tree/downloads", false, false);
        return File(
            getWellKnownFolder("DIRECTORY_DOWNLOADS").getFullPathName() + "/" +
            subDownloadPath);
      }

      return getLocalFileFromContentUri(
          URL("content://downloads/public_downloads/" + documentId));
      ...
      return getCursorDataColumn(
          URL("content://media/external/" + type + "/media"), "_id=?",
          StringArray{mediaId});
    }
  ...
  static String getFileNameFromContentUri(const URL &url) {
    ...
    auto filename =
        getStringUsingDataColumn("_display_name", env, uri, contentResolver);
...
private:
  //==============================================================================
  static String getCursorDataColumn(const URL &url,
    ...
    if (contentResolver) {
      ...
      LocalRef<jobjectArray> projection(
          env->NewObjectArray(1, JavaString, columnName.get()));

      LocalRef<jobjectArray> args;

      if (selection.isNotEmpty()) {
        args = LocalRef<jobjectArray>(env->NewObjectArray(
            selectionArgs.size(), JavaString, javaString("").get()));

        for (int i = 0; i < selectionArgs.size(); ++i)
          env->SetObjectArrayElement(args.get(), i,
                                     javaString(selectionArgs[i]).get());
      }

      LocalRef<jstring> jSelection(
          selection.isNotEmpty() ? javaString(selection) : LocalRef<jstring>());
      LocalRef<jobject> cursor(env->CallObjectMethod(
          contentResolver.get(), ContentResolver.query, uri.get(),
          projection.get(), jSelection.get(), args.get(), nullptr));

      if (jniCheckHasExceptionOccurredAndClear()) {
        // An exception has occurred, have you acquired
        // RuntimePermission::readExternalStorage permission?
        jassertfalse;
        return {};
      }

      if (cursor) {
        if (env->CallBooleanMethod(cursor.get(), AndroidCursor.moveToFirst) !=
            0) {
          auto columnIndex = env->CallIntMethod(
              cursor.get(), AndroidCursor.getColumnIndex, columnName.get());

          if (columnIndex >= 0) {
            LocalRef<jstring> value((jstring)env->CallObjectMethod(
                cursor.get(), AndroidCursor.getString, columnIndex));
  ...
  static File getPrimaryStorageDirectory() {
    return juceFile(LocalRef<jobject>(getEnv()->CallStaticObjectMethod(
        AndroidEnvironment, AndroidEnvironment.getExternalStorageDirectory)));
  }
  ...
  static Array<File> getSecondaryStorageDirectories() {
    ...
    if (getAndroidSDKVersion() >= 19) {
      auto *env = getEnv();
      static jmethodID m =
          (env->GetMethodID(AndroidContext, "getExternalFilesDirs",
                            "(Ljava/lang/String;)[Ljava/io/File;"));
      if (m == nullptr)
        return {};

      auto paths = convertFileArray(LocalRef<jobject>(
          env->CallObjectMethod(getAppContext().get(), m, nullptr)));
      ...
      for (const auto &iter : RangedDirectoryIterator(mountFolder, false, "*",
  ...
  static Array<File> convertFileArray(LocalRef<jobject> obj) {
    ...
    for (int i = 0; i < n; ++i)
      files.add(juceFile(LocalRef<jobject>(
          env->GetObjectArrayElement((jobjectArray)obj.get(), (jsize)i))));
  ...
  //==============================================================================
  static String
  getStringUsingDataColumn(const String &columnNameToUse, JNIEnv *env,
    ...
    LocalRef<jobject> cursor(env->CallObjectMethod(
        contentResolver.get(), ContentResolver.query, uri.get(),
        projection.get(), nullptr, nullptr, nullptr));
...
struct AndroidContentUriOutputStream final : public OutputStream {
  ...
  void flush() override { stream.callVoidMethod(AndroidOutputStream.flush); }

  bool setPosition(int64 newPos) override { return (newPos == pos); }
  ...
  bool write(const void *dataToWrite, size_t numberOfBytes) override {
    ...
    env->SetByteArrayRegion(javaArray, 0, (jsize)numberOfBytes,
                            (const jbyte *)dataToWrite);

    stream.callVoidMethod(AndroidOutputStream.write, javaArray, 0,
                          (jint)numberOfBytes);
...
struct AndroidStreamHelpers {
  ...
  static LocalRef<jobject> createStream(const GlobalRef &uri, StreamKind kind) {
    ...
    return LocalRef<jobject>(env->CallObjectMethod(
        contentResolver.get(),
...
struct AndroidContentUriInputStream final : public InputStream {
  explicit AndroidContentUriInputStream(const GlobalRef &uriIn)
      : uri(uriIn), stream(AndroidStreamHelpers::createStream(
                        uri, AndroidStreamHelpers::StreamKind::input)) {}
  ...
  int read(void *destBuffer, int maxBytesToRead) override {
    ...
    const auto result = env->CallIntMethod(
        stream.get(), AndroidInputStream.read, byteArray.getNativeArray());
    ...
    auto *rawBytes =
        env->GetByteArrayElements(byteArray.getNativeArray(), nullptr);
  ...
  void skipNextBytes(int64 num) override { skipImpl(num); }
...
private:
  bool skipImpl(int64 num) {
    ...
    const auto skipped =
        getEnv()->CallLongMethod(stream, AndroidInputStream.skip, (jlong)num);
...
static File getDocumentsDirectory() {
  ...
  return juceFile(LocalRef<jobject>(env->CallStaticObjectMethod(
      AndroidEnvironment, AndroidEnvironment.getDataDirectory)));
}

static File getAppDataDir(bool dataDir) {
  auto *env = getEnv();

  LocalRef<jobject> applicationInfo(env->CallObjectMethod(
      getAppContext().get(), AndroidContext.getApplicationInfo));
  LocalRef<jobject> jString(env->GetObjectField(
      applicationInfo.get(), dataDir ? AndroidApplicationInfo.dataDir
                                     : AndroidApplicationInfo.publicSourceDir));
...
File File::getSpecialLocation(const SpecialLocationType type) {
  ...
  case tempDirectory: {
    File tmp = getSpecialLocation(commonApplicationDataDirectory)
                   .getChildFile(".temp");
    tmp.createDirectory();
...
JUCE_API bool JUCE_CALLTYPE Process::openDocument(const String &fileName,
                                                  const String &) {
  ...
  LocalRef<jobject> intent(
      env->NewObject(AndroidIntent, AndroidIntent.constructWithUri,
                     action.get(), urlToUri(targetURL).get()));

  env->CallVoidMethod(getCurrentActivity(), AndroidContext.startActivity,
                      intent.get());
  return true;
}
...
public:
  SingleMediaScanner(const String &filename)
      : msc(LocalRef<jobject>(getEnv()->NewObject(
            MediaScannerConnection, MediaScannerConnection.constructor,
            getAppContext().get(),
            CreateJavaInterface(
                this, "android/media/"
  ...
  void onMediaScannerConnected() override {
    ...
    env->CallVoidMethod(msc.get(), MediaScannerConnection.scanFile,
                        javaString(file).get(), 0);
  }

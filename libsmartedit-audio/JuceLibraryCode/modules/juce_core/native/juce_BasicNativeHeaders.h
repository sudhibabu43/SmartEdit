...
#ifndef _CPPRTTI
#error                                                                         \
    "You're compiling without RTTI enabled! This is needed for a lot of JUCE classes, please update your compiler settings!"
#endif

#ifndef _CPPUNWIND
#error                                                                         \
    "You're compiling without exceptions enabled! This is needed for a lot of JUCE classes, please update your compiler settings!"
#endif
...
#ifndef S_FALSE
#define S_FALSE                                                                \
  (1) // (apparently some obscure win32 dev environments don't define this)
#endif
...
/* Used with DynamicLibrary to simplify importing functions from a win32 DLL.
   ...
   localFunctionName: name you want to use to actually call it (must be
   different) returnType: the return type params: list of params (bracketed)
*/
#define JUCE_LOAD_WINAPI_FUNCTION(dll, functionName, localFunctionName,        \
                                  returnType, params)                          \
  typedef returnType(WINAPI *type##localFunctionName) params;                  \
  type##localFunctionName localFunctionName =                                  \
      (type##localFunctionName)dll.getFunction(#functionName);

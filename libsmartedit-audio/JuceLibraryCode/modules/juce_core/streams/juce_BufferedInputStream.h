...
/** Wraps another input stream, and reads from it using an intermediate buffer
    ...
    If you're using an input stream such as a file input stream, and making lots
   of small read accesses to it, it's probably sensible to wrap it in one of
   these, so that the source stream gets accessed in larger chunk sizes, meaning
...
public:
  ...
  /** Creates a BufferedInputStream from an input source.
      ...
      @param bufferSize                   the size of reservoir to use to buffer
     the source
  ...
  */
  ...
  /** Creates a BufferedInputStream from an input source.
      ...
      @param sourceStream     the source stream to read from - the source stream
     must not be deleted until this object has been destroyed.

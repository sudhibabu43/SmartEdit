...
public:
  //==============================================================================
  /** Returns an IP address meaning "any", equivalent to 0.0.0.0 (IPv4) or ::,
   * (IPv6)  */
  ...
  /** Returns an IPv4 or IPv6 address meaning "localhost", equivalent to
  ...
  /** Returns the first 'real' address for the local machine.
      ...
      may return any of their addresses. If it doesn't find any, then it'll
     return local() as a fallback.
  */
  ...
  */
  ...
  IPAddress(uint8 address1, uint8 address2, uint8 address3,
            uint8 address4) noexcept;

  /** Creates an IPv6 address from 8 16-bit integers */
  IPAddress(uint16 address1, uint16 address2, uint16 address3, uint16 address4,
            uint16 address5, uint16 address6, uint16 address7,
            uint16 address8) noexcept;
  ...
  */
  ...
  /** Parses a string IP address of the form "1.2.3.4" (IPv4) or
  ...
  //==============================================================================
  /** Returns a dot- or colon-separated string in the form "1.2.3.4" (IPv4) or
   * "1:2:3:4:5:6:7:8" (IPv6). */
  String toString() const;

  /** Compares this IPAddress with another.

      @returns 0 if the two addresses are identical, negative if this address is
     smaller than the other one, or positive if is greater.
  */
  ...
  //==============================================================================
  /** Returns a formatted version of the provided IPv6 address conforming to RFC
     5952 with leading zeros suppressed, lower case characters, and double-colon
     notation used to represent contiguous 16-bit fields of zeros.
  ...
  */
  static IPAddress
  convertIPv4MappedAddressToIPv4(const IPAddress &mappedAddress);

  /** Converts an IPv4 address to an IPv4-mapped IPv6 address. */
  static IPAddress
  convertIPv4AddressToIPv4Mapped(const IPAddress &addressToMap);

  /** If the IPAdress is the address of an interface on the machine, returns the
     associated broadcast address. If the address is not an interface, it will
     return a null address.
  */
  static IPAddress
  getInterfaceBroadcastAddress(const IPAddress &interfaceAddress);
};

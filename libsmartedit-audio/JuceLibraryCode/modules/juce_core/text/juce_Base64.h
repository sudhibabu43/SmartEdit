...
struct JUCE_API Base64 {
  /** Converts a binary block of data into a base-64 string.
      ...
      If a write error occurs with the stream, the method will terminate and
     return false.
  */
  static bool convertToBase64(OutputStream &base64Result,
  ...
  /** Converts a base-64 string back to its binary representation.
      ...
      If the string is not valid base-64, the method will terminate and return
     false.
  */
  static bool convertFromBase64(OutputStream &binaryOutput,

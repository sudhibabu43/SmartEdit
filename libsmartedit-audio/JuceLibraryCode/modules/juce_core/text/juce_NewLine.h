...
/** This class is used for represent a new-line character sequence.
    ...
    To write a new-line to a stream, you can use the predefined 'newLine'
   variable, e.g.
    @code
    myOutputStream << "Hello World" << newLine << newLine;
    @endcode

    The exact character sequence that will be used for the new-line can be set
   and retrieved with OutputStream::setNewLineString() and
...
//==============================================================================
/** A predefined object representing a new-line, which can be written to a
   string or stream.
...
/** Writes a new-line sequence to a string.
    ...
    @endcode
*/
inline String &operator<<(String &string1, const NewLine &) {
...
inline String operator+(const NewLine &, const NewLine &) {
  return String(NewLine::getDefault()) + NewLine::getDefault();
}
inline String operator+(String s1, const NewLine &) {
  return s1 += NewLine::getDefault();
}
inline String operator+(const NewLine &, const char *s2) {

...
public:
  ...
  inline juce_wchar getAndAdvance() noexcept {
    return (juce_wchar)(uint8)*data++;
  }
  ...
  */
  static size_t getBytesRequiredFor(const juce_wchar) noexcept { return 1; }
  ...
  */
  ...
  /** Compares this string with another one, up to a specified number of
   * characters. */
  int compareUpTo(const CharPointer_ASCII other,

...
#if !JUCE_ANDROID // We currently don't request runtime permissions on any other
                  // platform than Android, so this file contains a dummy
                  // implementation for those. This may change in the future.

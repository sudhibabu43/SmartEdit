...
Result::Result(const String &message) noexcept : errorMessage(message) {}

Result::Result(const Result &other) : errorMessage(other.errorMessage) {}
...
const String &Result::getErrorMessage() const noexcept { return errorMessage; }

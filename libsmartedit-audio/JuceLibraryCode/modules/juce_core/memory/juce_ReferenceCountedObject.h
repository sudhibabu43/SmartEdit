...
/**
    ...
    efficient).
    For more details on how to use it, see the ReferenceCountedObject class
   notes.
...
protected:
  ...
  /** Copying from another object does not affect this one's reference-count. */
  SingleThreadedReferenceCountedObject(
      const SingleThreadedReferenceCountedObject &) {}
  /** Copying from another object does not affect this one's reference-count. */
  SingleThreadedReferenceCountedObject(
      SingleThreadedReferenceCountedObject &&) {}
  /** Copying from another object does not affect this one's reference-count. */
...
/**
   ...
   abbreviate the full templated name - e.g.
    ...
    @tags{Core}
*/
template <class ObjectType> class ReferenceCountedObjectPtr {
public:
  ...
  */
  ...
  ReferenceCountedObjectPtr(
      const ReferenceCountedObjectPtr<Convertible> &other) noexcept
  ...
  */
  template <typename Convertible>
  ReferenceCountedObjectPtr &
  operator=(const ReferenceCountedObjectPtr<Convertible> &other) {
  ...
  */
  ...
  /** Takes-over the object from another pointer. */
  ReferenceCountedObjectPtr &
  operator=(ReferenceCountedObjectPtr &&other) noexcept {
  ...
  */
  ...
  void reset() noexcept {
    ...
    referencedObject =
        nullptr; // in case this ptr is itself deleted as a side-effect
  ...
  */
  ...
  /** Returns the object that this pointer references.
      The pointer returned may be null, of course.
      Note that this methods allows the compiler to be very lenient with what it
     allows you to do with the pointer, it's safer to disable this by setting
     JUCE_STRICT_REFCOUNTEDPOINTER=1, which increased type safety and can
...
#ifndef DOXYGEN
  [[deprecated("Use the get method instead.")]] ReferencedType *
  getObject() const {
    return get();
  }
#endif

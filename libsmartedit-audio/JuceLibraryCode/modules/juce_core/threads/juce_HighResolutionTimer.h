...
public:
  ...
  */
  ...
  /** Starts the timer and sets the length of interval required.
     ...
     isTimerRunning() to confirm if the timer actually started.
      ...
      @param  intervalInMilliseconds  the interval to use (a value of zero or
  ...
  */
  ...
  /** Stops the timer.
     ...
     Once it returns, no more callbacks will be made. If it is called from the
     timer's own thread, it will cancel the timer after the current callback
     returns.

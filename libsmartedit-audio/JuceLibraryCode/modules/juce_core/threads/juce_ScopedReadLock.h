...
public:
  ...
  */
  ...
  /** Destructor.
      ...
      The ReadWriteLock's exitRead() method will be called when the destructor
     is called.
...
/**
    ...
    for (;;)
    {
        ...
        // Unlike using a ScopedReadLock, this may fail to actually get the
   lock, so you
   ...
   thread-unsafe
        ...
        {
            ..our attempt at locking failed because a write lock has already
   been issued..
        }
...
public:
  //==============================================================================
  /** Creates a ScopedTryReadLock and calls ReadWriteLock::tryEnterRead() as
     soon as it is created. When the ScopedTryReadLock object is destructed, the
  ...
  */
  ...
  /** Creates a ScopedTryReadLock.
     ...
     will call ReadWriteLock::tryEnterRead(), and when the ScopedTryReadLock

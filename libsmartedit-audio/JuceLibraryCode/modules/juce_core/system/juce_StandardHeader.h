...
*/
#define JUCE_VERSION                                                           \
  ((JUCE_MAJOR_VERSION << 16) + (JUCE_MINOR_VERSION << 8) + JUCE_BUILDNUMBER)

#if !DOXYGEN
#define JUCE_VERSION_ID                                                        \
  [[maybe_unused]] volatile auto juceVersionId =                               \
      "juce_version_" JUCE_STRINGIFY(JUCE_MAJOR_VERSION) "_" JUCE_STRINGIFY(   \
          JUCE_MINOR_VERSION) "_" JUCE_STRINGIFY(JUCE_BUILDNUMBER);
#endif
...
//==============================================================================
#ifndef JUCE_API
#define JUCE_API /**< This macro is added to all JUCE public class             \
                    declarations. */
#endif
...
#define JUCE_NAMESPACE                                                         \
  juce // This old macro is deprecated: you should just use the juce namespace
       // directly.
#endif

...
template <typename... Ts> constexpr bool isValueOrLvalueReferenceToConst() {
...
template <typename... Args> class CallbackListenerList {
public:
  static_assert(isValueOrLvalueReferenceToConst<Args...>(),
                "CallbackListenerList can only forward values or const lvalue "
                "references");

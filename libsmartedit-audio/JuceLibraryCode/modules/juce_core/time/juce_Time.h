...
public:
  ...
  /** Creates a Time object.
      This default constructor creates a time of midnight Jan 1st 1970 UTC,
     (which is represented internally as 0ms). To create a time object
     representing the current time, use getCurrentTime().
      @see getCurrentTime
  */
  Time() = default;
  ...
  */
  ...
  /** Creates a time from a set of date components.
      ...
      @param useLocalTime     if true, assume input is in this machine's local
     timezone if false, assume input is in UTC.
  */
  ...
  */
  ...
  /** Returns the name of the month (in this machine's local timezone).
      @param threeLetterVersion   if true, it'll be a 3-letter abbreviation,
     e.g. "Jan"; if false it'll return the long form, e.g. "January"
      @see getMonth
  */
  ...
  */
  ...
  /** Returns the number of the day of the week (in this machine's local
     timezone). The value returned is in the range 0 to 6 (0 = sunday, 1 =
     monday, etc).
  */
  int getDayOfWeek() const noexcept;

  /** Returns the number of the day of the year (in this machine's local
     timezone). The value returned is in the range 0 to 365.
  */
  int getDayOfYear() const noexcept;

  /** Returns the name of the weekday (in this machine's local timezone).
      @param threeLetterVersion   if true, it'll return a 3-letter abbreviation,
     e.g. "Tue"; if false, it'll return the full version, e.g. "Tuesday".
  */
  String getWeekdayName(bool threeLetterVersion) const;

  /** Returns the number of hours since midnight (in this machine's local
     timezone). This is in 24-hour clock format, in the range 0 to 23.
      @see getHoursInAmPmFormat, isAfternoon
  */
  int getHours() const noexcept;

  /** Returns true if the time is in the afternoon (in this machine's local
     timezone).
  ...
  */
  ...
  /** Returns the hours in 12-hour clock format (in this machine's local
     timezone). This will return a value 1 to 12 - use isAfternoon() to find out
  ...
  */
  ...
  /** Returns a string to indicate the offset of the local timezone from UTC.
      ...
      @param includeDividerCharacters  whether to include or omit the ":"
     divider in the string
   */
  String getUTCOffsetString(bool includeDividerCharacters) const;

  //==============================================================================
  /** Returns a string version of this date and time, using this machine's local
     timezone.

      For a more powerful way of formatting the date and time, see the
     formatted() method.

      @param includeDate      whether to include the date in the string
      @param includeTime      whether to include the time in the string
      @param includeSeconds   if the time is being included, this provides an
     option not to include the seconds in it
      @param use24HourClock   if the time is being included, sets whether to use
     am/pm or 24 hour notation.
      @see formatted
  */
  String toString(bool includeDate, bool includeTime,
                  bool includeSeconds = true,
                  bool use24HourClock = false) const;

  /** Converts this date/time to a string with a user-defined format.

      This uses the C strftime() function to format this time as a string. To
     save you looking it up, these are the escape codes that strftime uses
     (other codes might work on some platforms and not others, but these are the
     common ones):
     ...
     of the week) as a decimal number [00,53]. All days in a new year preceding
     the first Monday are considered to be in week 0.
      - %x  is replaced by the locale's appropriate date representation.
      - %X  is replaced by the locale's appropriate time representation.
      - %y  is replaced by the year without century as a decimal number [00,99].
      - %Y  is replaced by the year with century as a decimal number.
      - %Z  is replaced by the timezone name or abbreviation, or by no bytes if
  ...
  */
  ...
  /** Returns the number of millisecs since a fixed event (usually system
     startup).
      ...
      This returns a monotonically increasing value which is unaffected by
     changes to the system clock. It should be accurate to within a few
     millisecs, depending on platform, hardware, etc.

      Being a 32-bit return value, it will of course wrap back to 0 after 2^32
     seconds of uptime, so be careful to take that into account. If you need a
     64-bit time, you can use currentTimeMillis() instead.
  ...
  */
  ...
  /** Returns the number of millisecs since a fixed event (usually system
     startup).
      ...
      This has the same function as getMillisecondCounter(), but returns a more
     accurate value, using a higher-resolution timer if one is available.
  ...
  */
  ...
  /** Waits until the getMillisecondCounter() reaches a given value.
      ...
      This will make the thread sleep as efficiently as it can while it's
     waiting.
  */
  ...
  /** Less-accurate but faster version of getMillisecondCounter().
      ...
      This will return the last value that getMillisecondCounter() returned, so
     doesn't need to make a system call, but is less accurate - it shouldn't be
     more than 100ms away from the correct time, though, so is still accurate
  ...
  */
  ...
  /** Returns a Time based on the value of the __DATE__ macro when this module
   * was compiled */

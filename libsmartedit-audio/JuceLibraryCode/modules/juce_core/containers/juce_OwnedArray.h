...
public:
  ...
  */
  ~OwnedArray() { deleteAllObjects(); }

  /** Move constructor. */
  OwnedArray(OwnedArray &&other) noexcept : values(std::move(other.values)) {}
  ...
  OwnedArray(
      OwnedArray<OtherObjectClass, OtherCriticalSection> &&other) noexcept
      : values(std::move(other.values)) {}
  ...
  */
  inline ObjectClass **getRawDataPointer() noexcept { return values.begin(); }
  ...
  */
  ...
  /** Appends a new object to the end of the array.
      ...
      Note that this object will be deleted by the OwnedArray when it is
     removed, so be careful not to delete it somewhere else.
  ...
  */
  void insertArray(int indexToInsertAt, ObjectClass *const *newObjects,
  ...
  /** Replaces an object in the array with a different one.
     ...
     the end of the array.
      ...
      @param deleteOldElement     whether to delete the object that's being
     replaced with the new one
      @see add, insert, remove
  */
  ObjectClass *set(int indexToChange, ObjectClass *newObject,
    ...
    if (indexToChange >= 0) {
      ...
      jassertfalse; // you're trying to set an object at a negative index, which
                    // doesn't have any effect - but since the object is not
                    // being added, it may be leaking..
    }
  ...
  /** Replaces an object in the array with a different one.
     ...
     replaced with the new one
      @see add, insert, remove
  */
  ObjectClass *set(int indexToChange, std::unique_ptr<ObjectClass> newObject,
                   bool deleteOldElement = true) {
  ...
  */
  ...
  void addArray(const OtherArrayType &arrayToAddFrom, int startIndex = 0,
  ...
  /** Adds copies of the elements in another array to the end of this array.
      ...
      The other array must be either an OwnedArray of a compatible type of
     object, or an Array containing pointers to the same kind of object. The
     objects involved must provide a copy constructor, and this will be used to
     create new copies of each element, and add them to this array.
  ...
  */
  template <class OtherArrayType>
  void addCopiesOf(const OtherArrayType &arrayToAddFrom, int startIndex = 0,
                   int numElementsToAdd = -1) {
    const typename OtherArrayType::ScopedLockType lock1(
        arrayToAddFrom.getLock());
    const ScopedLockType lock2(getLock());
    ...
    if (numElementsToAdd < 0 ||
        startIndex + numElementsToAdd > arrayToAddFrom.size())
    ...
    while (--numElementsToAdd >= 0)
      values.add(
          createCopyIfNotNull(arrayToAddFrom.getUnchecked(startIndex++)));
  }
  ...
  /** Inserts a new object into the array assuming that the array is sorted.
     ...
     the sort method for details about this object's structure
  ...
  */
  void removeObject(const ObjectClass *objectToRemove,
  ...
  */
  ...
  /** Removes the last n objects from the array.
     ...
     array
      @param deleteObjects     whether to also delete the objects that are
     removed
      @see remove, removeObject, removeRange
  */
  void removeLast(int howManyToRemove = 1, bool deleteObjects = true) {
    ...
    if (howManyToRemove >= values.size())
      ...
      removeRange(values.size() - howManyToRemove, howManyToRemove,
                  deleteObjects);
  }

...
public:
  ...
  /** Two NamedValueSets are considered equal if they contain all the same
     key/value pairs, regardless of the order.
  */
  ...
  */
  var getWithDefault(const Identifier &name,
  ...
  */
  ...
  /** Returns a pointer to the var that holds a named value, or null if there is
      ...
      Do not use this method unless you really need access to the internal var
     object for some reason - for normal reading and writing always prefer
     operator[]() and set(). Also note that the pointer returned may become
     invalid as soon as any subsequent methods are called on the NamedValueSet.
  */
  ...
  */
  ...
  /** Returns the value of the item at a given index.
      ...
      Also note that the pointer returned may become invalid as soon as any
     subsequent methods are called on the NamedValueSet.
  */

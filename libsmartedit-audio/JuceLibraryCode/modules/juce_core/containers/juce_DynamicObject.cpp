...
var DynamicObject::invokeMethod(Identifier method,
...
void DynamicObject::clear() { properties.clear(); }
...
void DynamicObject::writeAsJSON(OutputStream &out,
  ...
  for (int i = 0; i < numValues; ++i) {
    ...
    JSON::writeToStream(out, properties.getValueAt(i),
                        format.withIndentLevel(format.getIndentLevel() +
                                               JSONFormatter::indentSize));

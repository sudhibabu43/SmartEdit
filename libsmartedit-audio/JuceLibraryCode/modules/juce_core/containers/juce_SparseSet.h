...
/**
    ...
    The type used as a template parameter must be an integer type, such as int,
   short, int64, etc.

    @tags{Core}
*/
template <class Type> class SparseSet {
public:
  //==============================================================================
  SparseSet() = default;
  ...
  */
  ...
  /** Returns the number of values in the set.
      ...
      Because of the way the data is stored, this method can take longer if
     there are a lot of items in the set. Use isEmpty() for a quick test of
  ...
  */
  ...
  /** Returns one of the values in the set.
      ...
      @param index    the index of the value to retrieve, in the range 0 to
     (size() - 1).
  ...
  */
  Range<Type> getTotalRange() const noexcept {
    ...
    return {ranges.getFirst().getStart(), ranges.getLast().getEnd()};
  }

  //==============================================================================
  /** Adds a range of contiguous values to the set.
      e.g. addRange (Range \<int\> (10, 14)) will add (10, 11, 12, 13) to the
     set.
  */
  ...
  /** Removes a range of values from the set.
      e.g. removeRange (Range\<int\> (10, 14)) will remove (10, 11, 12, 13) from
     the set.
  */

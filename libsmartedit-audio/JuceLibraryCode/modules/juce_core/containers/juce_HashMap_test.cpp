...
struct HashMapTest final : public UnitTest {
  ...
  //==============================================================================
  template <class Test> void doTest(const String &testName) {
    beginTest(testName);
  ...
  //==============================================================================
  template <typename KeyType, typename ValueType> struct AssociativeMap {
    struct KeyValuePair {
      KeyType key;
      ValueType value;
    };
  ...
  static void
  fillWithRandomValues(HashMap<KeyType, int> &hashMap,
  ...
  //==============================================================================
  template <typename KeyType> class RandomKeys {
  public:
...
template <> int HashMapTest::RandomKeys<int>::generateRandomKey(Random &rnd) {
  return rnd.nextInt();
}
template <>
...
template <>
String HashMapTest::RandomKeys<String>::generateRandomKey(Random &rnd) {
  String str;

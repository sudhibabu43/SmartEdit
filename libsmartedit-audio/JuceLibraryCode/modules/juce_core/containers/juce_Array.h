...
/**
    ...
    The Array class can be used to hold simple, non-polymorphic objects as well
   as primitive types - to do so, the class must fulfill these requirements:
    - it must have a copy constructor and assignment operator
    - it must be able to be relocated in memory by a memcpy without this causing
   any problems - so objects whose functionality relies on external pointers or
   references to themselves can not be used.

    You can of course have an array of pointers to any kind of object, e.g.
   Array<MyClass*>, but if you do this, the array doesn't take any ownership of
   the objects - see the OwnedArray class or the ReferenceCountedArray class for
   more powerful ways of holding lists of objects.

    For holding lists of strings, you can use Array\<String\>, but it's usually
   better to use the specialised class StringArray, which provides more useful
   functions.
...
public:
  ...
  */
  ...
  Array(ElementType &&firstNewElement, OtherElements &&...otherElements) {
    values.add(std::move(firstNewElement),
               std::forward<OtherElements>(otherElements)...);
  }
  ...
  */
  ...
  /** Removes all elements from the array.
      ...
      using. To clear the array without freeing the storage, use the
     clearQuick() method instead.
  ...
  */
  ...
  /** Removes all elements from the array without freeing the array's allocated
     storage.
      @see clear
  */
  void clearQuick() {
  ...
  */
  ...
  /** Returns one of the elements in the array, without checking the index
     passed in.
  ...
  */
  ...
  /** Returns a direct reference to one of the elements in the array, without
     checking the index passed in.

      This is like getUnchecked, but returns a direct reference to the element,
     so that you can alter it directly. Obviously this can be dangerous, so only
  ...
  */
  ...
  /** Returns a direct reference to one of the elements in the array, without
     checking the index passed in.
      ...
      This is like getUnchecked, but returns a direct reference to the element.
     Obviously this can be dangerous, so only use it when absolutely necessary.
  ...
  */
  ...
  /** Returns the first element in the array, or a default value if the array is
     empty.
  ...
  */
  ...
  /** Returns the last element in the array, or a default value if the array is
     empty.
  ...
  */
  ...
  /** Returns a pointer to the element which follows the last element in the
     array. This method is provided for compatibility with standard C++
  ...
  */
  ...
  /** Returns a pointer to the first element in the array.
      This method is provided for compatibility with the standard C++
     containers.
  */
  ...
  */
  ...
  /** Finds the index of the first element which matches the value passed in.
      ...
      of its first occurrence. If the object isn't found, the method will return
     -1.
  ...
  */
  ...
  /** Appends a new element at the end of the array.
      ...
      @see set, insert, addIfNotAlreadyThere, addSorted, addUsingDefaultSort,
     addArray
  */
  ...
  */
  ...
  template <typename... OtherElements>
  void add(const ElementType &firstNewElement,
  ...
  /** Inserts a new element into the array at a given position.
      ...
      Otherwise, it will be inserted into the array, moving all the later
     elements along to make room.
  ...
  */
  ...
  /** Inserts an array of values into this array at a given position.
      ...
      Otherwise, they will be inserted into the array, moving all the later
     elements along to make room.

      @param indexToInsertAt      the index at which the first new element
     should be inserted
      @param newElements          the new values to add to the array
      @param numberOfElements     how many items are in the array
      @see insert, add, addSorted, set
  */
  void insertArray(int indexToInsertAt, const ElementType *newElements,
  ...
  /** Appends a new element at the end of the array as long as the array doesn't
      ...
      If the array already contains an element that matches the one passed in,
     nothing will be done.

      @param newElement   the new object to add to the array
      @return             true if the element was added to the array; false
     otherwise.
  */
  ...
  /** Replaces an element with a new value.
      ...
      If the index is beyond the end of the array, the item is added to the end
     of the array.
  ...
  */
  ...
  /** Adds elements from an array to the end of this array.
      ...
      @param elementsToAdd        an array of some kind of object from which
  ...
  */
  ...
  /** Adds elements from a null-terminated array of pointers to the end of this
     array.

      @param elementsToAdd    an array of pointers to some kind of object from
     which elements can be constructed. This array must be terminated by a
     nullptr
      @see addArray
  */
  template <typename Type>
  ...
  /** This swaps the contents of this array with those of another array.
      ...
      If you need to exchange two arrays, this is vastly quicker than using
     copy-by-value because it just swaps their internal pointers.
  */
  template <class OtherArrayType>
  ...
  */
  ...
  void addArray(const OtherArrayType &arrayToAddFrom) {
    const typename OtherArrayType::ScopedLockType lock1(
        arrayToAddFrom.getLock());
  ...
  /** Adds elements from another array to the end of this array.
      ...
      @param arrayToAddFrom       the array from which to copy the elements
      @param startIndex           the first element of the other array to start
     copying from
      @param numElementsToAdd     how many elements to add from the other array.
     If this value is negative or greater than the number of available elements,
                                  all available elements will be copied.
      @see add
  */
  template <class OtherArrayType>
  std::enable_if_t<!std::is_pointer_v<OtherArrayType>, void>
  addArray(const OtherArrayType &arrayToAddFrom, int startIndex,
  ...
  /** This will enlarge or shrink the array to the given number of elements, by
     adding or removing items from its end.

      If the array is smaller than the given target size, empty elements will be
     appended until its size is as specified. If its size is larger than the
     target, items will be removed from its end to shorten it.
  */
  ...
  /** Inserts a new element into the array, assuming that the array is sorted.
      ...
      @param comparator   the comparator to use to compare the elements - see
     the sort() method for details about the form this object should take
  ...
  */
  ...
  int addSorted(ElementComparator &comparator, ParameterType newElement) {
    const ScopedLockType lock(getLock());
    auto index = findInsertIndexInSortedArray(comparator, values.begin(),
  ...
  /** Inserts a new element into the array, assuming that the array is sorted.
      ...
      This will use the DefaultElementComparator class for sorting, so your
     ElementType must be suitable for use with that class. If the array isn't
     sorted, the behaviour of this method will be unpredictable.
  ...
  */
  ...
  /** Finds the index of an element in the array, assuming that the array is
     sorted.

      This will use a comparator to do a binary-chop to find the index of the
     given element, if it exists. If the array isn't sorted, the behaviour of
     this method will be unpredictable.

      @param comparator           the comparator to use to compare the elements
     - see the sort() method for details about the form this object should take
      @param elementToLookFor     the element to search for
      @returns                    the index of the element, or -1 if it's not
     found
      @see addSorted, sort
  */
  ...
  /** Removes an element from the array.
      ...
      @see removeAndReturn, removeFirstMatchingValue, removeAllInstancesOf,
     removeRange
  */
  ...
  */
  ...
  /** Removes an item from the array.
      ...
      @returns               the index of the removed item, or -1 if the item
     isn't found
  ...
  */
  ...
  /** Removes items from the array.
      ...
      @param predicate   the condition when to remove an item. Must be a
     callable type that takes an ElementType and returns a bool

      @return how many objects were removed.
      @see remove, removeRange, removeAllInstancesOf
  */
  template <typename PredicateType> int removeIf(PredicateType &&predicate) {
    int numRemoved = 0;
    const ScopedLockType lock(getLock());
  ...
  */
  ...
  /** Removes the last n elements from the array.
      ...
      @param howManyToRemove   how many elements to remove from the end of the
     array
  ...
  */
  ...
  /** Removes any elements which are also in another array.
      ...
      @param otherArray   the other array in which to look for elements to
     remove
      @see removeValuesNotIn, remove, removeFirstMatchingValue,
  ...
  */
  ...
  /** Removes any elements which are not found in another array.
      ...
      @see removeValuesIn, remove, removeFirstMatchingValue,
     removeAllInstancesOf, removeRange
  */
  template <class OtherArrayType>
  ...
  */
  ...
  /** Moves one of the values to a different position.
      ...
      @param currentIndex     the index of the value to be moved. If this isn't
     a valid index, then nothing will be done
      @param newIndex         the index at which you'd like this value to end
     up. If this is less than zero, the value will be moved to the end of the
     array
  */
  ...
  */
  ...
  /** Increases the array's internal storage to hold a minimum number of
     elements.
  ...
  */
  ...
  /** Sorts the array using a default comparison operation.
      If the type of your elements isn't supported by the
     DefaultElementComparator class then you may need to use the other version
  ...
  */
  ...
  /** Returns the CriticalSection that locks this array.
      To lock, you can call getLock().enter() and getLock().exit(), or
     preferably use an object of ScopedLockType as an RAII lock for it.
  */
  ...
  //==============================================================================
#ifndef DOXYGEN
  [[deprecated("This method has been replaced by a more flexible templated "
               "version and renamed "
               "to swapWith to be more consistent with the names used in other "
               "classes.")]] void
  ...
  void minimiseStorageAfterRemoval() {
    if (values.capacity() > jmax(minimumAllocatedSize, values.size() * 2))
      values.shrinkToNoMoreThan(
          jmax(values.size(),
               jmax(minimumAllocatedSize, 64 / (int)sizeof(ElementType))));
  }
};

//==============================================================================
template <typename ElementType, typename TypeOfCriticalSectionToUse,
          int minimumAllocatedSize>
template <typename ElementComparator, typename TargetValueType>
int Array<ElementType, TypeOfCriticalSectionToUse, minimumAllocatedSize>::
    indexOfSorted([[maybe_unused]] ElementComparator &comparator,
                  TargetValueType elementToLookFor) const {
  const ScopedLockType lock(getLock());
...
void Array<ElementType, TypeOfCriticalSectionToUse, minimumAllocatedSize>::sort(
  ...
  const ScopedLockType lock(getLock());
  sortArray(comparator, values.begin(), 0, size() - 1,

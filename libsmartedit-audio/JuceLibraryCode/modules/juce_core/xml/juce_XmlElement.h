...
public:
  ...
  /** Creates an XmlElement with this tag name. */
  XmlElement(String::CharPointerType tagNameBegin,
  ...
  //==============================================================================
  /** Compares two XmlElements to see if they contain the same text and
     attributes.

      The elements are only considered equivalent if they contain the same
     attributes with the same values, and have the same sub-nodes.

      @param other                    the other element to compare to
      @param ignoreOrderOfAttributes  if true, this means that two elements with
     the same attributes in a different order will be considered the same; if
     false, the attributes must be in the same order as well
  */
  ...
  */
  struct TextFormat {
    ...
    String
        customHeader;      /**< If supplied, this header will be used (and
                              customEncoding & addDefaultHeader will be ignored). */
    String customEncoding; /**< If not empty and addDefaultHeader is true, this
                              will be set as the encoding. Otherwise, a default
                              of "UTF-8" will be used */
    bool addDefaultHeader =
        true; /**< If true, a default header will be generated; otherwise just
                 bare XML will be emitted. */
    int lineWrapLength = 60; /**< A maximum line length before wrapping is done.
                                (If newLineChars is nullptr, this is ignored) */
    const char *newLineChars =
        "\r\n"; /**< Allows the newline characters to be set. If you set this to
                   nullptr, then the whole XML document will be placed on a
                   single line. */

    [[nodiscard]] TextFormat
    singleLine() const; /**< returns a copy of this format with newLineChars set
                           to nullptr. */
    [[nodiscard]] TextFormat
    withoutHeader() const; /**< returns a copy of this format with the
                              addDefaultHeader flag set to false. */
  };

  /** Returns a text version of this XML element.
      If your intention is to write the XML to a file or stream, it's probably
     more efficient to use writeTo() instead of creating an intermediate string.
      @see writeTo
  */
  ...
  */
  ...
  /** Writes the document to a file as UTF-8.
      @see writeTo, toString
  */
  bool writeTo(const File &destinationFile,
  ...
  */
  ...
  /** Returns the namespace portion of the tag-name, or an empty string if none
   * is specified. */
  ...
  */
  ...
  /** Tests whether this element has a particular tag name, ignoring any XML
     namespace prefix. So a test for e.g. "xyz" will return true for "xyz" and
     also "foo:xyz", "bar::xyz", etc.
      @see getTagName
  */
  ...
  */
  ...
  /** Returns the value of a named attribute.
      @param attributeName        the name of the attribute to look up
      @param defaultReturnValue   a value to return if the element doesn't have
     an attribute with this name
  */
  String getStringAttribute(StringRef attributeName,
  ...
  /** Compares the value of a named attribute with a value passed-in.
      ...
      @param ignoreCase               whether the comparison should be
     case-insensitive
      @returns    true if the value of the attribute is the same as the string
     passed-in; false if it's different (or if no such attribute exists)
  */
  ...
  /** Returns the value of a named attribute as an integer.
     ...
     an attribute with this name
      @see setAttribute
  */
  int getIntAttribute(StringRef attributeName,
  ...
  /** Returns the value of a named attribute as floating-point.
     ...
     an attribute with this name
      @see setAttribute
  */
  double getDoubleAttribute(StringRef attributeName,
                            double defaultReturnValue = 0.0) const;

  /** Returns the value of a named attribute as a boolean.

      This will try to find the attribute and interpret it as a boolean. To do
     this, it'll return true if the value is "1", "true", "y", etc, or false for
     other values.
     ...
     an attribute with this name
  */
  bool getBoolAttribute(StringRef attributeName,
                        bool defaultReturnValue = false) const;

  /** Adds a named attribute to the element.

      If the element already contains an attribute with this name, it's value
     will be updated to the new value. If there's no such attribute yet, a new
     one will be added.
  ...
  */
  ...
  /** Adds a named attribute to the element, setting it to a floating-point
     value.
  ...
  */
  ...
  /** Returns the sub-element at a certain index.
      ...
      @returns the n'th child of this element, or nullptr if the index is
     out-of-range
  ...
  */
  ...
  /** Returns the first sub-element which has an attribute that matches the
     given value.

      @param attributeName     the name of the attribute to check
      @param attributeValue    the target value of the attribute
      @returns the first element with this attribute value, or nullptr if none
     is found
      @see getChildByName
  */
  ...
  /** Appends an element to this element's list of children.
      ...
      make sure the object that you pass in will not be deleted by anything
     else, and make sure it's not already the child of another element.

      Note that due to the XmlElement using a singly-linked-list,
     prependChildElement() is an O(1) operation, but addChildElement() is an
     O(N) operation - so if you're adding large number of elements, you may
     prefer to do so in reverse order!
  ...
  */
  ...
  /** Inserts an element into this element's list of children.
      ...
      @param indexToInsertAt  the index at which to insert the new element - if
     this is below zero, it will be added to the end of the list
  ...
  */
  ...
  /** Creates a new element with the given name and returns it, after adding it
      ...
      @code
      XmlElement* newElement = myParentElement->createNewChildElement
     ("foobar");
      @endcode
  */
  ...
  */
  ...
  /** Removes a child element.
      ...
      @param shouldDeleteTheChild     if true, the child will be deleted, if
  ...
  */
  ...
  /** Sorts the child elements using a comparator.
      ...
      This will use a comparator object to sort the elements into order. The
     object passed must have a method of the form:
      @code
     ...
     the comparator says are equivalent will be kept in the order in which they
                          currently appear in the array. This is slower to
     perform, but may be important in some cases. If it's false, a faster
     algorithm is used, but equivalent elements may be rearranged.
  */
  ...
  void sortChildElements(ElementComparator &comparator,
    ...
    if (num > 1) {
      ...
      sortArray(comparator, (XmlElement **)elems, 0, num - 1,
                retainOrderOfEquivalentItems);
  ...
  */
  ...
  /** Returns the text for a text element.
      ...
      then calling getText on the "xyz" element won't return "hello", because
     that is actually stored in a special text sub-element inside the xyz
     element. To get the "hello" string, you could either call getText on the
     (unnamed) sub-element, or use getAllSubText() to do this automatically.

      Note that leading and trailing whitespace will be included in the string -
     to remove if, just call String::trim() on the result.
  ...
  */
  ...
  /** Sets the text in a text element.
      ...
      Note that this is only a valid call if this element is a text element. If
     it's not, then no action will be performed. If you're trying to add text
     inside a normal element, you probably want to use addTextElement() instead.
  */
...
private:
  ...
  //==============================================================================
  template <typename Traits> class Iterator : private Traits {
  public:
...
public:
  ...
  */
  ...
  /** Allows iterating children of an XmlElement with a specific tag using
     range-for syntax.
     ...
     ("MYTAG")) doSomethingWithXmlElement (element);
      }
      @endcode
  */
  Iterator<GetNextElementWithTagName>
  getChildWithTagNameIterator(StringRef name) const {
  ...
  [[deprecated(
      "This has been deprecated in favour of the toString method.")]] String
  createDocument(StringRef dtdToUse, bool allOnOneLine = false,
                 bool includeXmlHeader = true, StringRef encodingType = "UTF-8",
                 int lineWrapLength = 60) const;

  [[deprecated(
      "This has been deprecated in favour of the writeTo method.")]] void
  writeToStream(OutputStream &output, StringRef dtdToUse,
                bool allOnOneLine = false, bool includeXmlHeader = true,
                StringRef encodingType = "UTF-8",
                int lineWrapLength = 60) const;

  [[deprecated(
      "This has been deprecated in favour of the writeTo method.")]] bool
  writeToFile(const File &destinationFile, StringRef dtdToUse,
              StringRef encodingType = "UTF-8", int lineWrapLength = 60) const;
#endif
...
private:
  ...
  // Sigh.. L"" or _T ("") string literals are problematic in general, and
  // really inappropriate for XML tags. Use a UTF-8 encoded literal instead, or
  // if you're really determined to use UTF-16, cast it to a String and use the
  // other constructor.
...
/** DEPRECATED: A handy macro to make it easy to iterate all the child elements
   in an XmlElement.

    New code should avoid this macro, and instead use getChildIterator directly.

    The parentXmlElement should be a reference to the parent XML, and the
   childElementVariableName will be the name of a pointer to each child element.
...
#define forEachXmlChildElement(parentXmlElement, childElementVariableName)     \
  for (auto *(childElementVariableName) :                                      \
       ((parentXmlElement).macroBasedForLoop(),                                \
        (parentXmlElement).getChildIterator()))

/** DEPRECATED: A macro that makes it easy to iterate all the child elements of
   an XmlElement which have a specified tag.

    New code should avoid this macro, and instead use
   getChildWithTagNameIterator directly.

    This does the same job as the forEachXmlChildElement macro, but only for
   those elements that have a particular tag name.

    The parentXmlElement should be a reference to the parent XML, and the
   childElementVariableName will be the name of a pointer to each child element.
   The requiredTagName is the tag name to match.
...
*/
#define forEachXmlChildElementWithTagName(                                     \
    parentXmlElement, childElementVariableName, requiredTagName)               \
  for (auto *(childElementVariableName) :                                      \
       ((parentXmlElement).macroBasedForLoop(),                                \
        (parentXmlElement).getChildWithTagNameIterator((requiredTagName))))

...
//==============================================================================
/**
    A type of timer class that can run multiple timers with different
   frequencies, all of which share a single callback.
...
protected:
  ...
  /** Creates a MultiTimer.
      ...
      When created, no timers are running, so use startTimer() to start things
     off.
  */
  MultiTimer() noexcept;
  ...
  /** Creates a copy of another timer.
      ...
      Note that this timer will not contain any running timers, even if the one
     you're copying from was running.
  */
...
public:
  ...
  */
  ...
  /** Starts a timer and sets the length of interval required.
      ...
      @param timerID                  a unique Id number that identifies the
     timer to start. This is the id that will be passed back to the
     timerCallback() method when this timer is triggered
      @param  intervalInMilliseconds  the interval to use (any values less than
  ...
  */
  ...
  /** Stops a timer.
      ...
      If a timer has been started with the given ID number, it will be
     cancelled. No more callbacks will be made for the specified timer after
     this method returns.
  ...
  */
  ...
  /** Returns the interval for a specified timer ID.
     ...
     no timer was running for the ID number specified.
  */

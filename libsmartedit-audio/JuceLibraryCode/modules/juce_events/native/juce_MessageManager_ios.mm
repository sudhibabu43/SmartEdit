...
bool MessageManager::runDispatchLoopUntil(int millisecondsToRunFor) {
  JUCE_AUTORELEASEPOOL {
    ...
    NSDate *endDate =
        [NSDate dateWithTimeIntervalSinceNow:millisecondsToRunFor * 0.001];
      ...
      JUCE_AUTORELEASEPOOL {
        ...
        if (millisecondsToRunFor >= 0 &&
            Time::getMillisecondCounter() >=
                startTime + (uint32)millisecondsToRunFor)
          break;
      }
    }
...
void MessageManager::doPlatformSpecificShutdown() { messageQueue = nullptr; }

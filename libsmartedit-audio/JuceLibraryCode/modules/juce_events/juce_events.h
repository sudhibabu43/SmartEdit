...
/*******************************************************************************
 ...
 BEGIN_JUCE_MODULE_DECLARATION
  ...
  description:        Classes for running an application's main event loop and
sending/receiving messages, timers, etc. website: http://www.juce.com/juce : ISC
...
/** Config: JUCE_EXECUTE_APP_SUSPEND_ON_BACKGROUND_TASK
    Will execute your application's suspend method on an iOS background task,
   giving you extra time to save your applications state.
*/
...
// functionality without the WinRT libraries installed on your system. Try
// installing the latest Windows Standalone SDK and maybe also adding the path
// to the WinRT headers to your build system. This path should have the form

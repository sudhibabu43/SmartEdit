...
template <> struct SIMDNativeOps<uint32_t> {
  ...
  static forcedinline vSIMDType set(vSIMDType v, size_t i,
                                    uint32_t s) noexcept {
    return fb::set(v, i, s);
  }
  ...
  static forcedinline vSIMDType greaterThanOrEqual(vSIMDType a,
                                                   vSIMDType b) noexcept {
    return (vSIMDType)vcgeq_u32(a, b);
  }
  static forcedinline vSIMDType multiplyAdd(vSIMDType a, vSIMDType b,
                                            vSIMDType c) noexcept {
...
template <> struct SIMDNativeOps<int8_t> {
  ...
  static forcedinline bool allEqual(vSIMDType a, vSIMDType b) noexcept {
    return (SIMDNativeOps<int32_t>::sum(
                (SIMDNativeOps<int32_t>::vSIMDType)notEqual(a, b)) == 0);
  }
  static forcedinline vSIMDType multiplyAdd(vSIMDType a, vSIMDType b,
                                            vSIMDType c) noexcept {
...
template <> struct SIMDNativeOps<uint8_t> {
  ...
  static forcedinline bool allEqual(vSIMDType a, vSIMDType b) noexcept {
    return (SIMDNativeOps<uint32_t>::sum(
                (SIMDNativeOps<uint32_t>::vSIMDType)notEqual(a, b)) == 0);
  }
  static forcedinline vSIMDType multiplyAdd(vSIMDType a, vSIMDType b,
                                            vSIMDType c) noexcept {
...
template <> struct SIMDNativeOps<float> {
  ...
  static forcedinline vSIMDType bit_not(vSIMDType a) noexcept {
    return bit_notand(a, vld1q_f32((float *)kAllBitsSet));
  }
  static forcedinline vSIMDType min(vSIMDType a, vSIMDType b) noexcept {
...
template <> struct SIMDNativeOps<double> {
  ...
  static forcedinline void store(vSIMDType value, double *a) noexcept {
    vst1q_f64(a, value);
  }
  static forcedinline vSIMDType add(vSIMDType a, vSIMDType b) noexcept {
  ...
  static forcedinline vSIMDType bit_not(vSIMDType a) noexcept {
    return bit_notand(a, vld1q_f64((double *)kAllBitsSet));
  }
  static forcedinline vSIMDType min(vSIMDType a, vSIMDType b) noexcept {

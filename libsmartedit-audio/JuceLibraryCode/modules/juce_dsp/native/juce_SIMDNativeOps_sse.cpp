...
DEFINE_SSE_SIMD_CONST(int32_t, float, kEvenHighBit) = {
    static_cast<int32_t>(0x80000000), 0, static_cast<int32_t>(0x80000000), 0};
...
DEFINE_SSE_SIMD_CONST(int16_t, int16_t, kAllBitsSet) = {-1, -1, -1, -1,
                                                        -1, -1, -1, -1};
...
DEFINE_SSE_SIMD_CONST(uint32_t, uint32_t, kHighBit) = {0x80000000, 0x80000000,
                                                       0x80000000, 0x80000000};

DEFINE_SSE_SIMD_CONST(int64_t, int64_t, kAllBitsSet) = {-1, -1};

DEFINE_SSE_SIMD_CONST(uint64_t, uint64_t, kAllBitsSet) = {0xffffffffffffffff,
                                                          0xffffffffffffffff};
DEFINE_SSE_SIMD_CONST(uint64_t, uint64_t, kHighBit) = {0x8000000000000000,
                                                       0x8000000000000000};
} // namespace juce::dsp

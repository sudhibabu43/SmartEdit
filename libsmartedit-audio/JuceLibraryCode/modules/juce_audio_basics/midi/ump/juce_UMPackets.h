...
/**
    ...
    If timestamps are required, these can be added to the container in UMP
   format, as Jitter Reduction Utility messages.
...
public:
  ...
  */
  ...
  /** Pre-allocates space for at least `numWords` 32-bit words in this
   * collection. */
  ...
  /** Gets a pointer to the contents of the collection as a range of raw 32-bit
   * words. */
...
private:
  template <size_t numWords> void addImpl(const Packet<numWords> &p) {

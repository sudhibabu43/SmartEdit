...
public:
  ...
  /** Creates a 3-byte short midi message.
      ...
      @param timeStamp        the time to give the midi message - this value
     doesn't use any particular units, so will be application-specific
  */
  ...
  */
  ...
  MidiMessage(int byte1, int byte2, int byte3, Data... otherBytes)
    ...
    jassert(size > 3 || byte1 >= 0xf0 ||
            getMessageLengthFromFirstByte((uint8)byte1) == size);

    const uint8 data[] = {(uint8)byte1, (uint8)byte2, (uint8)byte3,
                          static_cast<uint8>(otherBytes)...};
  ...
  /** Reads the next midi message from some data.
      ...
      @param maxBytesToUse            the maximum number of bytes it's allowed
     to read
      @param numBytesUsed             returns the number of bytes that were
     actually needed
      @param lastStatusByte           in a sequence of midi messages, the
     initial byte can be dropped from a message if it's the same as the first
     byte of the previous message, so this lets you supply the byte to use if
     the first byte of the message has in fact been dropped.
      @param timeStamp                the time to give the midi message - this
     value doesn't use any particular units, so will be application-specific
      @param sysexHasEmbeddedLength   when reading sysexes, this flag indicates
     whether to expect the data to begin with a variable-length field indicating
     its size
  */
  MidiMessage(const void *data, int maxBytesToUse, int &numBytesUsed,
              uint8 lastStatusByte, double timeStamp = 0,
              bool sysexHasEmbeddedLength = true);

  /** Creates an empty sysex message.

      Since the MidiMessage has to contain a valid message, this default
     constructor just initialises it with an empty sysex message.
  */
  ...
  */
  ...
  /** Returns the timestamp associated with this message.
      ...
      The exact meaning of this time and its units will vary, as messages are
     used in a variety of different contexts.

      If you're getting the message from a midi file, this could be a time in
     seconds, or a number of ticks - see
     MidiFile::convertTimestampTicksToSeconds().

      If the message is being used in a MidiBuffer, it might indicate the number
     of audio samples from the start of the buffer.

      If the message was created by a MidiInput, see
     MidiInputCallback::handleIncomingMidiMessage() for details of the way that
     it initialises this value.
  ...
  */
  ...
  /** Changes the message's associated timestamp.
      The units for the timestamp will be application-specific - see the notes
     for getTimeStamp().
  ...
  */
  ...
  /** Returns the midi channel associated with the message.
      ...
      @returns    a value 1 to 16 if the message has a channel, or 0 if it
     hasn't (e.g. if it's a sysex)
  ...
  */
  ...
  /** Returns true if the message applies to the given midi channel.
      ...
      @param channelNumber    the channel number to look for, in the range 1 to
     16
  ...
  */
  ...
  /** Changes the message's midi channel.
      ...
      @param newChannelNumber    the channel number to change it to, in the
     range 1 to 16
  */
  ...
  */
  ...
  /** Returns true if this message is a 'key-down' event.
      ...
      @param returnTrueForVelocity0   if true, then if this event is a note-on
     with velocity 0, it will still be considered to be a note-on and the method
     will return true. If returnTrueForVelocity0 is false, then if this is a
     note-on event with velocity 0, it'll be regarded as a note-off, and the
  ...
  */
  ...
  /** Creates a key-down message (using a floating-point velocity).
      ...
      @see isNoteOn
  */
  static MidiMessage noteOn(int channel, int noteNumber,
  ...
  */
  ...
  /** Multiplies the velocity of a note-on or note-off message by a given
     amount.
  ...
  */
  ...
  /** Returns true if this message is a 'sostenuto pedal down' controller
   * message. */
  ...
  */
  ...
  /** Returns the pitch wheel position from a pitch-wheel move message.
      ...
      The value returned is a 14-bit number from 0 to 0x3fff, indicating the
     wheel position. If called for messages which aren't pitch wheel events, the
     number returned will be nonsense.
  ...
  */
  ...
  /** Returns the amount of aftertouch from an aftertouch messages.
      ...
      The value returned is in the range 0 to 127, and will be nonsense for
     messages other than aftertouch messages.
  ...
  */
  ...
  /** Creates an aftertouch message.
      ...
      @see isAftertouch
  */
  static MidiMessage aftertouchChange(int channel, int noteNumber,
                                      int aftertouchAmount) noexcept;

  /** Returns true if the message is a channel-pressure change event.

      This is like aftertouch, but common to the whole channel rather than a
     specific note. Use getChannelPressureValue() to find out the pressure, and
     getChannel() to find out the channel.
  ...
  */
  ...
  /** Returns the controller number of a controller message.
      ...
      The name of the controller can be looked up using the getControllerName()
     method. Note that the value returned is invalid for messages that aren't
     controller changes.
  ...
  */
  ...
  /** Returns the controller value from a controller message.
      ...
      Note that the value returned is invalid for messages that aren't
     controller changes.
  ...
  */
  ...
  /** Returns true if this message is a controller message and if it has the
  ...
  */
  ...
  /** Creates a controller message.
      ...
      @see isController
  */
  static MidiMessage controllerEvent(int channel, int controllerType,
                                     int value) noexcept;
  ...
  */
  ...
  /** Returns true if this event is a meta-event.
      ...
      @see getMetaEventType, isTrackMetaEvent, isEndOfTrackMetaEvent,
           isTextMetaEvent, isTrackNameEvent, isTempoMetaEvent,
     isTimeSignatureMetaEvent, isKeySignatureMetaEvent, isMidiChannelMetaEvent
  */
  ...
  */
  ...
  /** Returns the tick length from a tempo meta-event.
      ...
      @param timeFormat   the 16-bit time format value from the midi file's
     header.
  ...
  */
  ...
  /** Returns the key from a key-signature meta-event.
      ...
      A positive number here indicates the number of sharps in the key
     signature, and a negative number indicates a number of flats. So e.g. 3 =
     F# + C# + G#, -2 = Bb + Eb
  ...
  */
  ...
  /** Creates a key-signature meta-event.
      @param numberOfSharpsOrFlats    if positive, this indicates the number of
     sharps in the key; if negative, the number of flats
      @param isMinorKey               if true, the key is minor; if false, it is
     major
      @see isKeySignatureMetaEvent
  */
  static MidiMessage keySignatureMetaEvent(int numberOfSharpsOrFlats,
                                           bool isMinorKey);
  ...
  */
  ...
  /** Creates a song-position-pointer message.
      ...
      The position is a number of midi beats from the start of the song, where 1
     midi beat is 6 midi clocks, and there are 24 midi clocks in a quarter-note.
     So there are 4 midi beats in a quarter-note.
  ...
  */
  ...
  /** Returns the value from a quarter-frame message.
      This will be the lower nybble of the message's data-byte, a value between
     0 and 15
  */
  ...
  /** Creates a quarter-frame MTC message.
      ...
      @param sequenceNumber   a value 0 to 7 for the upper nybble of the
     message's data byte
      @param value            a value 0 to 15 for the lower nybble of the
     message's data byte
  */
  ...
  */
  void getFullFrameParameters(int &hours, int &minutes, int &seconds,
                              int &frames,
                              SmpteTimecodeType &timecodeType) const noexcept;

  /** Creates a full-frame MTC message. */
  static MidiMessage fullFrame(int hours, int minutes, int seconds, int frames,
                               SmpteTimecodeType timecodeType);

  //==============================================================================
  /** Types of MMC command.

      @see isMidiMachineControlMessage, getMidiMachineControlCommand,
  ...
  */
  ...
  /** Checks whether this is an MMC message.
      If it is, you can use the getMidiMachineControlCommand() to find out its
     type.
  */
  ...
  /** For an MMC message, this returns its type.
      ...
      Make sure it's actually an MMC message with isMidiMachineControlMessage()
  ...
  */
  ...
  /** Checks whether this is an MMC "goto" message.
      If it is, the parameters passed-in are set to the time that the message
     contains.
      @see midiMachineControlGoto
  */
  bool isMidiMachineControlGoto(int &hours, int &minutes, int &seconds,
  ...
  */
  static MidiMessage midiMachineControlGoto(int hours, int minutes, int seconds,
                                            int frames);
  ...
  */
  [[deprecated("This signature has been deprecated in favour of the safer "
               "readVariableLengthValue.")]] static int
  readVariableLengthVal(const uint8 *data, int &numBytesUsed) noexcept;
#endif
  ...
  */
  ...
  /** Reads a midi variable-length integer, with protection against buffer
     overflow.

      @param data             the data to read the number from
      @param maxBytesToUse    the number of bytes in the region following `data`
      @returns                a struct containing the parsed value, and the
     number of bytes that were read. If parsing fails, both the `value` and
     `bytesUsed` fields will be set to 0 and `isValid()` will return false
  */
  static VariableLengthValue
  readVariableLengthValue(const uint8 *data, int maxBytesToUse) noexcept;
  ...
  */
  ...
  /** Returns the name of a midi note number.
      ...
      @param useSharps            if true, sharpened notes are used, e.g. "C#",
     otherwise they'll be flattened, e.g. "Db"
      @param includeOctaveNumber  if true, the octave number will be appended to
     the string, e.g. "C#4"
      @param octaveNumForMiddleC  if an octave number is being appended, this
     indicates the number that will be used for middle C's octave

      @see getMidiNoteInHertz
  */
  static String getMidiNoteName(int noteNumber, bool useSharps,
                                bool includeOctaveNumber,
                                int octaveNumForMiddleC);

  /** Returns the frequency of a midi note number.

      The frequencyOfA parameter is an optional frequency for 'A', normally
     440-444Hz for concert pitch.
      @see getMidiNoteName
  */
  static double getMidiNoteInHertz(int noteNumber,
                                   double frequencyOfA = 440.0) noexcept;

  /** Returns true if the given midi note number is a black key. */
  static bool isMidiNoteBlack(int noteNumber) noexcept;

  /** Returns the standard name of a GM instrument, or nullptr if unknown for
     this index.
  ...
  */
  ...
  /** Returns the name of a bank of GM instruments, or nullptr if unknown for
     this bank number.
      @param midiBankNumber   the bank, 0 to 15
  */
  static const char *getGMInstrumentBankName(int midiBankNumber);

  /** Returns the standard name of a channel 10 percussion sound, or nullptr if
     unknown for this note number.
      @param midiNoteNumber   the key number, 35 to 81
  */
  static const char *getRhythmInstrumentName(int midiNoteNumber);

  /** Returns the name of a controller type number, or nullptr if unknown for
     this controller number.
      @see getControllerNumber
  */
  static const char *getControllerName(int controllerNumber);

  /** Converts a floating-point value between 0 and 1 to a MIDI 7-bit value
   * between 0 and 127. */
  static uint8 floatValueToMidiByte(float valueBetween0and1) noexcept;

  /** Converts a pitchbend value in semitones to a MIDI 14-bit pitchwheel
   * position value. */
  static uint16
...
private:
  ...
  inline uint8 *getData() const noexcept {
    return isHeapAllocated() ? packedData.allocatedData
                             : (uint8 *)packedData.asBytes;
  }

...
public:
  ...
  */
  int process(double speedRatio, const float *inputSamples,
    ...
    return interpolateImpl(speedRatio, inputSamples, outputSamples,
  ...
  */
  int process(double speedRatio, const float *inputSamples,
    ...
    return interpolateImpl(speedRatio, inputSamples, outputSamples,
                           ...
                           wrapAround, processReplacingCallback());
  }
  ...
  */
  int processAdding(double speedRatio, const float *inputSamples,
    ...
    return interpolateImpl(speedRatio, inputSamples, outputSamples,
                           numOutputSamplesToProduce, numInputSamplesAvailable,
                           wrapAround, processAddingCallback(gain));
  }
...
private:
  ...
  int interpolateImpl(double speedRatio, const float *input, float *output,
                      int numOutputSamplesToProduce,
                      int numInputSamplesAvailable, int wrap, Process process) {
    ...
    interpolateImpl(speedRatio, output, numOutputSamplesToProduce, process,
                    pushSample);
  ...
  template <typename Process>
  int interpolateImpl(double speedRatio, const float *input, float *output,
                      int numOutputSamplesToProduce, Process process) {
    int numUsed = 0;

    interpolateImpl(
        speedRatio, output, numOutputSamplesToProduce, process,
  ...
  void interpolateImpl(double speedRatio, float *output,
                       int numOutputSamplesToProduce, Process process,
    ...
    for (auto i = 0; i < numOutputSamplesToProduce; ++i) {
      ...
      *output =
          process(*output, InterpolatorTraits::valueAtOffset(

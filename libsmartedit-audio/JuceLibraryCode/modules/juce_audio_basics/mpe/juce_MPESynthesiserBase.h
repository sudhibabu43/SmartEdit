...
/**
    ...
    Implement the callbacks of MPEInstrument::Listener (noteAdded,
   notePressureChanged etc.) to let your audio generator know that MPE notes
   were triggered, modulated, or released. What to do inside them, and how that
   influences your audio generator, is up to you!
    ...
    something more sophisticated, have a look at MPESynthesiser. This class
   extends MPESynthesiserBase by adding the concept of voices that can play
   notes, a voice stealing algorithm, and much more.
...
public:
  ...
  /** Constructor.
      ...
      If you use this constructor, the synthesiser will use the provided
     instrument object to handle the MPE note state logic. This is useful if you
     want to use an instance of your own class derived from MPEInstrument for
     the MPE logic.
  */
  ...
  */
  ...
  /** Re-sets the synthesiser's internal MPE zone layout to the one passed in.
      ...
      call noteReleased for all of them, and disable legacy mode (if previously
     enabled).
  */
  ...
  */
  ...
  /** Puts the synthesiser into legacy mode.
      ...
      @param pitchbendRange   The note pitchbend range in semitones to use when
     in legacy mode. Must be between 0 and 96, otherwise behaviour is undefined.
                              The default pitchbend range in legacy mode is +/-
     2 semitones.
      @param channelRange     The range of MIDI channels to use for notes when
     in legacy mode. The default is to use all MIDI channels (1-16).
  ...
  */
  ...
  /** Returns the range of MIDI channels (1-16) to be used for notes when in
   * legacy mode. */
  Range<int> getLegacyModeChannelRange() const noexcept;

  /** Re-sets the range of MIDI channels (1-16) to be used for notes when in
   * legacy mode. */
  void setLegacyModeChannelRange(Range<int> channelRange);

  /** Returns the pitchbend range in semitones (0-96) to be used for notes when
   * in legacy mode. */
  int getLegacyModePitchbendRange() const noexcept;

  /** Re-sets the pitchbend range in semitones (0-96) to be used for notes when
   * in legacy mode. */

...
/**
    Parses a continuous bytestream and emits complete MidiMessages whenever a
...
struct BytestreamToBytestreamHandler : public BytestreamInputHandler {
  ...
  */
  ...
  public:
    ...
    std::unique_ptr<BytestreamToBytestreamHandler>
    operator()(MidiInput &i) const {
      if (callback != nullptr)
...
/**
    Parses a continuous MIDI 1.0 bytestream, and emits full messages in the

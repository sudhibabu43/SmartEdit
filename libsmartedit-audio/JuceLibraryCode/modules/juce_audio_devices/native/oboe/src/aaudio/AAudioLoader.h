...
typedef void (*AAudioStream_errorCallback)(AAudioStream *stream, void *userData,
...
#define AAUDIO_STREAM_STATE_STARTING                                           \
  static_cast<aaudio_stream_state_t>(StreamState::Starting)
#define AAUDIO_STREAM_STATE_STARTED                                            \
 ...
 * To avoid linker errors, we dynamically link with the functions by name using
 * dlsym(). On older versions this linkage will safely fail.
 */
class AAudioLoader {
public:
  ...
  typedef int32_t (*signature_I_PBPPS)(
      AAudioStreamBuilder *,
      AAudioStream **stream); // AAudioStreamBuilder_open()

  typedef int32_t (*signature_I_PB)(
      AAudioStreamBuilder *); // AAudioStreamBuilder_delete()
  ...
  typedef int32_t (*signature_I_PS)(
      AAudioStream *); // AAudioStream_getSampleRate()
  typedef int64_t (*signature_L_PS)(
      AAudioStream *); // AAudioStream_getFramesRead()
  ...
  typedef int32_t (*signature_I_PSPVIL)(AAudioStream *, void *, int32_t,
                                        int64_t);
  typedef int32_t (*signature_I_PSCPVIL)(AAudioStream *, const void *, int32_t,
                                         int64_t);

  typedef int32_t (*signature_I_PSTPTL)(AAudioStream *, aaudio_stream_state_t,
                                        aaudio_stream_state_t *, int64_t);

  typedef int32_t (*signature_I_PSKPLPL)(AAudioStream *, clockid_t, int64_t *,
                                         int64_t *);

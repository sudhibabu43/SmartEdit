...
static void *smartedit_swig_pylong_as_ptr(PyObject *obj) {
    if (!obj) {
        return nullptr;
    }
...
%extend smartedit::Profile {
    bool __eq__(const smartedit::Profile& other) const {
        return (*self == other);
    }
    bool __lt__(const smartedit::Profile& other) const {
        return (*self < other);
    }
    bool __gt__(const smartedit::Profile& other) const {
        return (*self > other);
    }
}
...
%extend smartedit::SmartEditVersion {
    ...
    const std::string __str__() {
        return std::string(SMARTEDIT_VERSION_FULL);
    }
